...
def_pcfunk2(ansi__stream__print_code, stream, code, return f2__ansi__stream__print_code(this_cause, stream, code));
...
def_pcfunk1(ansi__stream__beep, stream, return f2__ansi__stream__beep(this_cause, stream));
...
def_pcfunk2(ansi__stream__foreground, stream, color, return f2__ansi__stream__foreground(this_cause, stream, color));
