...
f2ptr f2__fibermon_fiber__construct_fast(f2ptr cause, f2ptr this) {
  ...
  f2ptr this__environment_menu_item                       = raw__gtk__menu_item__new(cause, new__string(cause, "Environment"));                              f2__frame__add_var_value(cause, this, new__symbol(cause, "environment_menu_item"),                       this__environment_menu_item);
  f2ptr this__environment_menu                            = raw__gtk__menu__new(cause);                                                                      f2__frame__add_var_value(cause, this, new__symbol(cause, "environment_menu"),                            this__environment_menu);
  f2ptr this__environment_globally_define_fiber_menu_item = raw__gtk__menu_item__new(cause, new__string(cause, "Globally Define Fiber"));                    f2__frame__add_var_value(cause, this, new__symbol(cause, "environment_globally_define_fiber_menu_item"), this__environment_globally_define_fiber_menu_item);
