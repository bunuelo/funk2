...
f2ptr f2__compile__funk_local_copy(f2ptr cause, f2ptr funk)                           {return bcs_valid(raw__cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__funk_local_copy__symbol,     funk,   nil,   nil), nil));}
...
f2ptr raw__expression__optimize__local_apply(f2ptr cause, f2ptr expression) {
  ...
  if (raw__cons__is_type(cause, cdr)) {
    ...
    if (raw__cons__is_type(cause, funkable)) {
      ...
      if (raw__eq(cause, funkable__command, __funk2.globalenv.bytecode__symbol)) {
...
f2ptr raw__expression__optimize__and(f2ptr cause, f2ptr expression) {
  f2ptr cdr = f2cons__cdr(expression, cause);
  if (raw__cons__is_type(cause, cdr)) {
    f2ptr arg1     = f2cons__car(cdr, cause);
    f2ptr cdr__cdr = f2cons__cdr(cdr, cause);
	...
	if ((arg1_optimized != nil) &&
      ...
      if ((arg1 != arg1_optimized) ||
	  (arg2 != arg2_optimized)) {
	return f2list3__new(cause, __funk2.globalenv.bytecode_and__symbol, arg1_optimized, arg2_optimized);
      }
    }
  }
  return expression;
...
f2ptr raw__expression__optimize__or(f2ptr cause, f2ptr expression) {
  f2ptr cdr = f2cons__cdr(expression, cause);
  if (raw__cons__is_type(cause, cdr)) {
    f2ptr arg1     = f2cons__car(cdr, cause);
    f2ptr cdr__cdr = f2cons__cdr(cdr, cause);
	...
	if ((arg1_optimized != nil) ||
      ...
      if ((arg1 != arg1_optimized) ||
	  (arg2 != arg2_optimized)) {
	return f2list3__new(cause, __funk2.globalenv.bytecode_or__symbol, arg1_optimized, arg2_optimized);
      }
    }
  }
  return expression;
...
f2ptr raw__expression__replace_variable__special_symbol_exp(f2ptr cause, f2ptr fiber, f2ptr env, f2ptr exp, f2ptr replace_variable, f2ptr replace_argument) {
  ...
  if (raw__symbol__eq(cause, car, __funk2.globalenv.bytecode__symbol))                      {return assert_value(raw__expression__replace_variable__bytecode(cause, fiber, env, exp, replace_variable, replace_argument));}
  if (raw__symbol__eq(cause, car, __funk2.globalenv.rawcode__symbol))                       {return assert_value(raw__expression__replace_variable__funkvar_call(cause, fiber, env, exp, replace_variable, replace_argument));}
