...
f2ptr f2__compile__funk_bc(f2ptr cause, bool bytecode_tracing_on)                                               {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__funk__symbol,      nil,    nil,   nil),   nil));}
f2ptr f2__compile__jump_funk(f2ptr cause, bool bytecode_tracing_on)                                             {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__jump_funk__symbol, nil,    nil,   nil),   nil));}
f2ptr f2__compile__array(f2ptr cause, bool bytecode_tracing_on, f2ptr length)                                   {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__array__symbol,     length, nil,   nil),   nil));}
f2ptr f2__compile__cons(f2ptr cause, bool bytecode_tracing_on)                                                  {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__cons__symbol,      nil,    nil,   nil),   nil));}
f2ptr f2__compile__car(f2ptr cause, bool bytecode_tracing_on)                                                   {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__car__symbol,       nil,    nil,   nil),   nil));}
f2ptr f2__compile__cdr(f2ptr cause, bool bytecode_tracing_on)                                                   {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__cdr__symbol,       nil,    nil,   nil),   nil));}
f2ptr f2__compile__car__set(f2ptr cause, bool bytecode_tracing_on)                                              {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__car__set__symbol,  nil,    nil,   nil),   nil));}
f2ptr f2__compile__cdr__set(f2ptr cause, bool bytecode_tracing_on)                                              {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__cdr__set__symbol,  nil,    nil,   nil),   nil));}
f2ptr f2__compile__array_elt(f2ptr cause, bool bytecode_tracing_on, f2ptr array, f2ptr index)                   {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__array_elt__symbol, array,  index, nil), nil));}
f2ptr f2__compile__set(f2ptr cause, bool bytecode_tracing_on, f2ptr reg, f2ptr exp)                             {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__set__symbol,       reg,    exp,   nil),   nil));}
...
f2ptr f2__compile__swap(f2ptr cause, bool bytecode_tracing_on, f2ptr reg0, f2ptr reg1)                          {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__swap__symbol, reg0, reg1, nil), nil));}
...
f2ptr f2__compile__push(f2ptr cause, bool bytecode_tracing_on, f2ptr reg)                                       {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__push__symbol, reg, nil, nil),  nil));}
...
f2ptr f2__compile__pop(f2ptr cause, bool bytecode_tracing_on, f2ptr reg)                                        {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__pop__symbol,  reg, nil, nil), nil));}
...
f2ptr f2__compile__copy(f2ptr cause, bool bytecode_tracing_on, f2ptr reg0, f2ptr reg1)                          {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__copy__symbol, reg0, reg1, nil), nil));}
...
f2ptr f2__compile__lookup_type_var(f2ptr cause, bool bytecode_tracing_on, f2ptr type, f2ptr var)                {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__lookup_type_var__symbol, type, var, nil), nil));}
...
f2ptr f2__compile__define_type_var(f2ptr cause, bool bytecode_tracing_on, f2ptr type, f2ptr var)                {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__define_type_var__symbol, type, var, nil), nil));}
f2ptr f2__compile__type_var__set(f2ptr cause, bool bytecode_tracing_on, f2ptr type, f2ptr var)                  {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__type_var__set__symbol, type, var, nil), nil));}
f2ptr f2__compile__globalize_type_var(f2ptr cause, bool bytecode_tracing_on, f2ptr type, f2ptr var)             {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__globalize_type_var__symbol, type, var, nil), nil));}
f2ptr f2__compile__jump(f2ptr cause, bool bytecode_tracing_on, f2ptr new_pc)                                    {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__jump__symbol, new_pc, nil, nil), nil));}
f2ptr f2__compile__else_jump(f2ptr cause, bool bytecode_tracing_on, f2ptr new_pc)                               {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__else_jump__symbol, new_pc, nil, nil), nil));}
f2ptr f2__compile__nop(f2ptr cause, bool bytecode_tracing_on)                                                   {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__nop__symbol, nil, nil, nil), nil));}
...
f2ptr f2__compile__debug(f2ptr cause, bool bytecode_tracing_on, f2ptr value)                                    {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__debug__symbol, value, nil, nil), nil));}
f2ptr f2__compile__trace(f2ptr cause, bool bytecode_tracing_on, f2ptr value)                                    {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__trace__symbol, value, nil, nil), nil));}
f2ptr f2__compile__compile(f2ptr cause, bool bytecode_tracing_on, f2ptr protect_environment, f2ptr tw_compiled) {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__compile__symbol, tw_compiled, protect_environment, nil), nil));}
f2ptr f2__compile__yield(f2ptr cause, bool bytecode_tracing_on)                                                 {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__yield__symbol, nil, nil, nil), nil));}
f2ptr f2__compile__newenv(f2ptr cause, bool bytecode_tracing_on)                                                {return bcs_valid(f2cons__new(cause, f2bytecode__new(cause, __funk2.bytecode.bytecode__newenv__symbol, nil, nil, nil), nil));}
