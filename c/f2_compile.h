...
extern f2ptr f2__compile__rawcode(f2ptr context, bool tracewrap, f2ptr thread, f2ptr exps, bool protect_environment, bool optimize_tail_recursion, bool *popped_env_and_return);
