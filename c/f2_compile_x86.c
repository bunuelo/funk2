  ...
  f2ptr jumps                 = f2machine_code_chunk__jumps(                this, cause);
  {
	...
	if (raw__eq(cause, jump__command, new__symbol(cause, "movabs-label"))) {
	  ...
	  if (raw__x86_funk__is_type(cause, funktion)) {
	    ...
	    raw__expression__compile_x86_to_chunk__movabs__constant_rax(cause, chunk, jump__index__i, funktion__jump_ptr);
	    ...
	    f2ptr funktion__stack_machine_code_pointer = f2cfunk__stack_machine_code_pointer(funktion, cause);
	    if (raw__pointer__is_type(cause, funktion__stack_machine_code_pointer)) {
	      ptr   funktion__relative_ptr  = f2pointer__p(funktion__stack_machine_code_pointer, cause);
	      u64   funktion__jump_location = to_ptr(relative_ptr__to__raw_executable(funktion__relative_ptr));
	      raw__expression__compile_x86_to_chunk__movabs__constant_rax(cause, chunk, jump__index__i, funktion__jump_location);
	    } else {
	      return new__error(f2list6__new(cause,
	    ...
	    return new__error(f2list6__new(cause,
					   new__symbol(cause, "bug_name"),   new__symbol(cause, "expression-compile_x86-finalize_jumps-stack_funkall-invalid_funktion_type"),
					   new__symbol(cause, "this"),       this,
					   new__symbol(cause, "funktion"),   funktion));
	  }
	} else {
...
//  4000a5:	48 89 d1             	mov    %rdx,%rcx

f2ptr raw__expression__compile_x86__mov__rdx__rcx(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0x89);
...
//  4000a8:	48 89 d2             	mov    %rdx,%rdx

f2ptr raw__expression__compile_x86__mov__rdx__rdx(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0x89);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xD2);
  return f2__machine_code_chunk__new(cause, chunk);
}
...
//  4000ae:	48 89 d7             	mov    %rdx,%rdi

f2ptr raw__expression__compile_x86__mov__rdx__rdi(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0x89);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xD7);
  return f2__machine_code_chunk__new(cause, chunk);
}

//  4000b1:	49 89 d0             	mov    %rdx,%r8

f2ptr raw__expression__compile_x86__mov__rdx__r8(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
...
//  4000b4:	49 89 d1             	mov    %rdx,%r9

f2ptr raw__expression__compile_x86__mov__rdx__r9(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x49);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0x89);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xD1);
...
f2ptr raw__expression__compile_x86__mov(f2ptr cause, f2ptr expression) {
  ...
  if (raw__expression__is_register_expression(cause, argument_0)) {
	...
	if      (raw__eq(cause, register_name_1, new__symbol(cause, "rax"))) {return raw__expression__compile_x86__mov__rsi__rax(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "rcx"))) {return raw__expression__compile_x86__mov__rsi__rcx(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "rdx"))) {return raw__expression__compile_x86__mov__rsi__rdx(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "rsi"))) {return raw__expression__compile_x86__mov__rsi__rsi(cause);}
	else {
	  return new__error(f2list6__new(cause,
					 new__symbol(cause, "bug_name"),      new__symbol(cause, "expression-compile_x86-mov-unknown_register_name"),
					 new__symbol(cause, "register_name"), register_name_1,
	...
	if      (raw__eq(cause, register_name_1, new__symbol(cause, "rax"))) {return raw__expression__compile_x86__mov__rdx__rax(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "rcx"))) {return raw__expression__compile_x86__mov__rdx__rcx(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "rdx"))) {return raw__expression__compile_x86__mov__rdx__rdx(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "rsi"))) {return raw__expression__compile_x86__mov__rdx__rsi(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "rdi"))) {return raw__expression__compile_x86__mov__rdx__rdi(cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "r8")))  {return raw__expression__compile_x86__mov__rdx__r8( cause);}
	else if (raw__eq(cause, register_name_1, new__symbol(cause, "r9")))  {return raw__expression__compile_x86__mov__rdx__r9( cause);}
	else {
	  return new__error(f2list6__new(cause,
					 new__symbol(cause, "bug_name"),      new__symbol(cause, "expression-compile_x86-mov-unknown_register_name"),
					 new__symbol(cause, "register_name"), register_name_1,
...
f2ptr raw__expression__compile_x86__movabs__constant__register(f2ptr cause, s64 constant_value, f2ptr register_name) {
  if      (raw__eq(cause, register_name, new__symbol(cause, "rax"))) {return raw__expression__compile_x86__movabs__constant_rax(cause, constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rdi"))) {return raw__expression__compile_x86__movabs__constant_rdi(cause, constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rsi"))) {return raw__expression__compile_x86__movabs__constant_rsi(cause, constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rdx"))) {return raw__expression__compile_x86__movabs__constant_rdx(cause, constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rcx"))) {return raw__expression__compile_x86__movabs__constant_rcx(cause, constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "r8")))  {return raw__expression__compile_x86__movabs__constant_r8( cause, constant_value);}
...
f2ptr raw__expression__compile_x86__movabs__label__register(f2ptr cause, f2ptr label_name, f2ptr register_name) {
  u64   label_constant_value = 0;
  f2ptr machine_code_chunk   = nil;
  if      (raw__eq(cause, register_name, new__symbol(cause, "rax"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rax(cause, label_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rdi"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rdi(cause, label_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rsi"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rsi(cause, label_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rdx"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rdx(cause, label_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rcx"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rcx(cause, label_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "r8")))  {machine_code_chunk = raw__expression__compile_x86__movabs__constant_r8( cause, label_constant_value);}
  ...
  f2ptr machine_code_jump__arguments = f2list1__new(cause, register_name);
...
f2ptr raw__expression__compile_x86__movabs__funkvar__register(f2ptr cause, f2ptr funkvar_name, f2ptr register_name) {
  u64   funkvar_constant_value = 0;
  f2ptr machine_code_chunk     = nil;
  if      (raw__eq(cause, register_name, new__symbol(cause, "rax"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rax(cause, funkvar_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rdi"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rdi(cause, funkvar_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rsi"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rsi(cause, funkvar_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rdx"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rdx(cause, funkvar_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "rcx"))) {machine_code_chunk = raw__expression__compile_x86__movabs__constant_rcx(cause, funkvar_constant_value);}
  else if (raw__eq(cause, register_name, new__symbol(cause, "r8")))  {machine_code_chunk = raw__expression__compile_x86__movabs__constant_r8( cause, funkvar_constant_value);}
...
f2ptr raw__expression__compile_x86__movabs(f2ptr cause, f2ptr expression) {
  ...
  if (raw__expression__is_constant_expression(cause, argument_0)) {
    ...
    if (raw__expression__is_register_expression(cause, argument_1)) {
      f2ptr register_name_1 = raw__register_expression__register_name(cause, argument_1);
      return raw__expression__compile_x86__movabs__constant__register(cause, constant_value__p, register_name_1);
    } else {
      return new__error(f2list4__new(cause,
    ...
    if (raw__expression__is_register_expression(cause, argument_1)) {
      f2ptr register_name_1 = raw__register_expression__register_name(cause, argument_1);
      return raw__expression__compile_x86__movabs__label__register(cause, label_name, register_name_1);
    } else {
      return new__error(f2list4__new(cause,
				     new__symbol(cause, "bug_name"),   new__symbol(cause, "expression-compile_x86-movabs-invalid_argument_expression_type"),
				     new__symbol(cause, "expression"), expression));
    ...
    if (raw__expression__is_register_expression(cause, argument_1)) {
      f2ptr register_name_1 = raw__register_expression__register_name(cause, argument_1);
      return raw__expression__compile_x86__movabs__funkvar__register(cause, funkvar_name, register_name_1);
    } else {
      return new__error(f2list4__new(cause,
				     new__symbol(cause, "bug_name"),   new__symbol(cause, "expression-compile_x86-movabs-invalid_argument_expression_type"),
				     new__symbol(cause, "expression"), expression));
...
//  4000a2:	48 ff c8             	dec    %rax

f2ptr raw__expression__compile_x86__decq__rax(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0xFF);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xC8);
...
//  4000a5:	48 ff c9             	dec    %rcx

f2ptr raw__expression__compile_x86__decq__rcx(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0xFF);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xC9);
  return f2__machine_code_chunk__new(cause, chunk);
}

//  4000a8:	48 ff ca             	dec    %rdx

f2ptr raw__expression__compile_x86__decq__rdx(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0xFF);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xCA);
...
//  4000ab:	48 ff ce             	dec    %rsi

f2ptr raw__expression__compile_x86__decq__rsi(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0xFF);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xCE);
  return f2__machine_code_chunk__new(cause, chunk);
}

//  4000ae:	48 ff cf             	dec    %rdi

f2ptr raw__expression__compile_x86__decq__rdi(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0xFF);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xCF);
  return f2__machine_code_chunk__new(cause, chunk);
}

//  4000b1:	49 ff c8             	dec    %r8

f2ptr raw__expression__compile_x86__decq__r8(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x49);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0xFF);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xC8);
...
//  4000b4:	49 ff c9             	dec    %r9

f2ptr raw__expression__compile_x86__decq__r9(f2ptr cause) {
  f2ptr chunk = raw__chunk__new(cause, 3);
  raw__chunk__bit8__elt__set(cause, chunk, 0, 0x49);
  raw__chunk__bit8__elt__set(cause, chunk, 1, 0xFF);
  raw__chunk__bit8__elt__set(cause, chunk, 2, 0xC9);
...
//  4000b7:	48 ff 4d e0          	decq   -0x20(%rbp)

f2ptr raw__expression__compile_x86__decq__relative_rbp(f2ptr cause, s64 relative_offset) {
  if ((relative_offset >= -128) &&
      (relative_offset <   128)) {
    f2ptr chunk = raw__chunk__new(cause, 4);
    raw__chunk__bit8__elt__set(cause, chunk, 0, 0x48);
    ...
    return new__error(f2list4__new(cause,
				   new__symbol(cause, "bug_name"),        new__symbol(cause, "expression-compile_x86-decq-unknown_relative_offset_range"),
				   new__symbol(cause, "relative_offset"), f2integer__new(cause, relative_offset)));
  }
}

f2ptr raw__expression__compile_x86__decq(f2ptr cause, f2ptr expression) {
  if (raw__simple_length(cause, expression) != 2) {
    return new__error(f2list4__new(cause,
				   new__symbol(cause, "bug_name"),   new__symbol(cause, "expression-compile_x86-decq-invalid_expression_length"),
				   new__symbol(cause, "expression"), expression));
  }
  f2ptr argument = f2cons__car(f2cons__cdr(expression, cause), cause);
  if (raw__expression__is_register_expression(cause, argument)) {
    f2ptr register_name = raw__register_expression__register_name(cause, argument);
    if      (raw__eq(cause, register_name, new__symbol(cause, "rax"))) {return raw__expression__compile_x86__decq__rax(cause);}
    else if (raw__eq(cause, register_name, new__symbol(cause, "rcx"))) {return raw__expression__compile_x86__decq__rcx(cause);}
    else if (raw__eq(cause, register_name, new__symbol(cause, "rdx"))) {return raw__expression__compile_x86__decq__rdx(cause);}
    else if (raw__eq(cause, register_name, new__symbol(cause, "rsi"))) {return raw__expression__compile_x86__decq__rsi(cause);}
    else if (raw__eq(cause, register_name, new__symbol(cause, "rdi"))) {return raw__expression__compile_x86__decq__rdi(cause);}
    else if (raw__eq(cause, register_name, new__symbol(cause, "r8")))  {return raw__expression__compile_x86__decq__r8( cause);}
    else if (raw__eq(cause, register_name, new__symbol(cause, "r9")))  {return raw__expression__compile_x86__decq__r9( cause);}
    else {
      return new__error(f2list6__new(cause,
				     new__symbol(cause, "bug_name"),      new__symbol(cause, "expression-compile_x86-decq-unknown_register_name"),
				     new__symbol(cause, "register_name"), register_name,
				     new__symbol(cause, "expression"),    expression));
    }
  } else if (raw__expression__is_relative_expression(cause, argument)) {
    ...
    if (raw__expression__is_register_expression(cause, relative_expression__argument)) {
      f2ptr register_name = raw__register_expression__register_name(cause, relative_expression__argument);
      if (raw__eq(cause, register_name, new__symbol(cause, "rbp"))) {return raw__expression__compile_x86__decq__relative_rbp(cause, relative_offset_value);}
      else {
	return new__error(f2list6__new(cause,
				       new__symbol(cause, "bug_name"),      new__symbol(cause, "expression-compile_x86-movq-unknown_register"),
				       new__symbol(cause, "register_name"), register_name,
    ...
    return new__error(f2list4__new(cause,
				   new__symbol(cause, "bug_name"),   new__symbol(cause, "expression-compile_x86-decq-invalid_argument_expression_type"),
				   new__symbol(cause, "expression"), expression));
  }
}
...
f2ptr raw__expression__compile_x86__stack_funkall(f2ptr cause, f2ptr expression) {
  ...
  if (raw__expression__is_funkvar_expression(cause, argument_0)) {
    ...
    {
      f2ptr machine_code_chunk           = raw__expression__compile_x86__movabs__constant_rax(cause, jump_ptr);
      f2ptr machine_code_jump__index     = f2integer__new(cause, 0);
    ...
    return f2__machine_code_chunk_list__concat(cause, f2list3__new(cause,
