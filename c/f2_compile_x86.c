...
void f2__chunk__compile_x86__value_bit8( f2ptr this, u32 index, f2ptr cause, u32* next_index, u8  value) {if (this) {f2chunk__bit8__elt__set( this, index, cause, value);} *next_index = index + 1;}
void f2__chunk__compile_x86__value_bit16(f2ptr this, u32 index, f2ptr cause, u32* next_index, u16 value) {if (this) {f2chunk__bit16__elt__set(this, index, cause, value);} *next_index = index + 2;}
void f2__chunk__compile_x86__value_bit32(f2ptr this, u32 index, f2ptr cause, u32* next_index, u32 value) {if (this) {f2chunk__bit32__elt__set(this, index, cause, value);} *next_index = index + 4;}
...
void f2__chunk__compile_x86__push_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__pop_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__ret(f2ptr this, u32 index, f2ptr cause, u32* next_index) {
  f2__chunk__compile_x86__value_bit8(this, index, cause, next_index, 0xC3);
}

//80483ff:	e8 b0 ff ff ff       	call   80483b4 <test1>

void f2__chunk__compile_x86__call(f2ptr this, u32 index, f2ptr cause, u32* next_index, s32 relative_address) {
...
void f2__chunk__compile_x86__call_absolute(f2ptr this, u32 index, f2ptr cause, u32* next_index, u32 absolute_address) {
  s32 relative_jump_addr;
  if (this != nil) {
    u32 after_call_index;
...
void f2__chunk__compile_x86__call_eax(f2ptr this, u32 index, f2ptr cause, u32* next_index) {
...
void f2__chunk__compile_x86__add(f2ptr this, u32 index, f2ptr cause, u32* next_index, u8 value) {
...
void f2__chunk__compile_x86__sub__const_from_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, u8 value) {
...
void f2__chunk__compile_x86__leave(f2ptr this, u32 index, f2ptr cause, u32* next_index) {
...
void f2__chunk__compile_x86__movl(f2ptr this, u32 index, f2ptr cause, u32* next_index, u32 constant, u32 addr) {
...
void f2__chunk__compile_x86__mov_const_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, u32 constant, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_eax_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_ecx_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_edx_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_ebx_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_esp_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_ebp_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_esi_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_edi_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t src_reg, x86_reg_t dest_reg) {
  switch(src_reg) {
...
void f2__chunk__compile_x86__mov_reg_to_eax_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_ecx_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_edx_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_ebx_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_esp_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_ebp_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_esi_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_edi_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_to_reg_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t src_reg, x86_reg_t dest_reg, u8 offset) {
  switch(dest_reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_eax(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_ecx(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_edx(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_ebx(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_esp(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_ebp(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_esi(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_edi(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t reg, u8 offset) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_reg_offset_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, x86_reg_t src_reg, u8 offset, x86_reg_t dest_reg) {
  switch(dest_reg) {
...
void f2__chunk__compile_x86__mov_const_to_reg_addr(f2ptr this, u32 index, f2ptr cause, u32* next_index, u32 constant, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__mov_const_to_reg_offset(f2ptr this, u32 index, f2ptr cause, u32* next_index, u32 constant, x86_reg_t reg, s8 offset) {
  switch(reg) {
  case x86_reg__eax:
...
void f2__chunk__compile_x86__mov_addr_to_reg(f2ptr this, u32 index, f2ptr cause, u32* next_index, u32 addr, x86_reg_t reg) {
  switch(reg) {
...
void f2__chunk__compile_x86__jump_bytecode(f2ptr this, u32 index, f2ptr cause, u32* next_index, bytecode_jump_t jump_bytecode) {
...
void f2__chunk__compile_x86__jump_bytecode__f2ptr(f2ptr this, u32 index, f2ptr cause, u32* next_index,
...
void f2__chunk__compile_x86__jump_bytecode__f2ptr_f2ptr(f2ptr this, u32 index, f2ptr cause, u32* next_index, bytecode_jump__f2ptr_f2ptr_t jump_bytecode, f2ptr arg0, f2ptr arg1) {
...
void f2__chunk__compile_x86__bytecode(f2ptr this, u32 index, f2ptr cause, u32* next_index, f2ptr bytecode) {
...
void f2__chunk__compile_x86__return_if_eax_is_true(f2ptr this, u32 index, f2ptr cause, u32* next_index, f2ptr expected_pc) {
...
void f2__chunk__compile_x86__bytecodes(f2ptr this, u32 index, f2ptr cause, u32* next_index, f2ptr bytecodes) {
...
void f2__chunk__compile_x86__funk(f2ptr this, u32 index, f2ptr cause, u32* next_index, f2ptr funk) {
  u8* iter;
...
void f2__chunk__compile_x86__metro(f2ptr this, u32 index, f2ptr cause, u32* next_index, f2ptr metro) {
  u8* iter;
  iter = compile_x86__funk__header;
  int i;
  for (i = compile_x86__funk__header__length; i > 0; i --) {
