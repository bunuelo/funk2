...
f2ptr raw__machine_code_chunk__new(f2ptr cause, f2ptr chunk, f2ptr index_label_ptypehash, f2ptr relative_jump_expressions) {
  return f2machine_code_chunk__new(cause, chunk, index_label_ptypehash, relative_jump_expressions);
}
...
f2ptr raw__machine_code_chunk__terminal_print_with_frame(f2ptr cause, f2ptr this, f2ptr terminal_print_frame) {
  ...
  if (frame == nil) {
    frame = f2__frame__new(cause, f2list8__new(cause,
					       ...
					       new__symbol(cause, "relative_jump_expressions"), f2__machine_code_chunk__relative_jump_expressions(cause, this)));
    f2__ptypehash__add(cause, print_as_frame_hash, this, frame);
  }
  return raw__frame__terminal_print_with_frame(cause, frame, terminal_print_frame);
}
...
void f2__compile_x86__reinitialize_globalvars() {
  ...
  initialize_primobject_3_slot(machine_code_chunk, chunk, index_label_ptypehash, relative_jump_expressions);
