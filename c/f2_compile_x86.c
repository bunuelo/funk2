...
void f2__chunk__compile_x86__bytecode(f2ptr this, uint index, f2ptr cause, uint* next_index, f2ptr bytecode) {
  ...
  else if (command == __funk2.bytecode.bytecode__type_var__set__symbol)      {f2__chunk__compile_x86__jump_bytecode__f2ptr_f2ptr(this, index, cause, next_index, &f2__thread__bytecode__type_var__set, f2bytecode__arg0(bytecode, cause), f2bytecode__arg1(bytecode, cause));}
