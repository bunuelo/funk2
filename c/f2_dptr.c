...
void funk2_garbage_collector_pool__grey_referenced_elements_from_dptr(funk2_dptr_t* dptr, funk2_garbage_collector_pool_t* this, int pool_index) {
  ...
  funk2_garbage_collector_pool__grey_maybe_other_element(this, pool_index, dptr->mutate_funks);
  funk2_garbage_collector_pool__grey_maybe_other_element(this, pool_index, dptr->read_funks);
}
