...
boolean_t f2__fiber__execute_bytecode(f2ptr cause, f2ptr fiber, f2ptr bytecode) {
  ...
  else if (command == __funk2.bytecode.bytecode__funk_local_copy__symbol)            {f2__fiber__bytecode__funk_local_copy(           fiber, bytecode, f2bytecode__arg0(bytecode, cause), f2bytecode__arg1(bytecode, cause));}
