...
boolean_t raw__physical_object__is_type(f2ptr cause, f2ptr thing) {return raw__eq(cause, new__symbol(cause, "physical_object"), f2__frame__lookup_var_value(cause, thing, new__symbol(cause, "type"), nil));}
