...
void funk2_garbage_collector_pool__signal_enter_protected_region(funk2_garbage_collector_pool_t* this) {
  debug__assert((! __funk2.memory.bootstrapping_mode) && (pthread_self() != __funk2.memory.memory_handling_thread), nil, "memory handling thread attempted to protect memory.");
