...
f2ptr raw__graph_node__as__dot_code(f2ptr cause, f2ptr this) {
  ...
  f2ptr node_code     = f2__graphviz__node(cause, f2__graphviz__exp__as__name(cause, eq_hash_value), f2__graphviz__exp__as__label(cause, eq_hash_value), color);
  return node_code;
}
...
f2ptr raw__graph_edge__as__dot_code(f2ptr cause, f2ptr this) {
  ...
  f2ptr this__left_node__eq_hash_value  = f2__graph_node__label(cause, this__left_node);
  f2ptr this__right_node__eq_hash_value = f2__graph_node__label(cause, this__right_node);
  f2ptr edge_code                       = f2__graphviz__raw_labelled_edge(cause, this__eq_hash_value, f2__graphviz__exp__as__name(cause, this__left_node__eq_hash_value), f2__graphviz__exp__as__name(cause, this__right_node__eq_hash_value));
  return edge_code;
}
...
def_pcfunk1(graph__node_count, this, return f2__graph__node_count(this_cause, this));
...
def_pcfunk1(graph__random_nonempty_strict_subgraph, this, return f2__graph__random_nonempty_strict_subgraph(this_cause, this));
...
def_pcfunk0(graph_isomorphism__new, return f2__graph_isomorphism__new(this_cause));
...
def_pcfunk3(graph_isomorphism__add_mapping, this, left_node, right_node, return f2__graph_isomorphism__add_mapping(this_cause, this, left_node, right_node));
...
def_pcfunk1(graph_isomorphism__mapping_count, this, return f2__graph_isomorphism__mapping_count(this_cause, this));
...
def_pcfunk0(graph_decomposition_lattice__new, return f2__graph_decomposition_lattice__new(this_cause));
...
def_pcfunk3(graph_decomposition_lattice__decompose_graph_with_root_graph, this, graph, root_graph, return f2__graph_decomposition_lattice__decompose_graph_with_root_graph(this_cause, this, graph, root_graph));
...
def_pcfunk2(graph_decomposition_lattice__decompose_graph, this, graph, return f2__graph_decomposition_lattice__decompose_graph(this_cause, this, graph));
...
void f2__graph__initialize() {
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(graph_node__terminal_print_with_frame, this, terminal_print_frame, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_graph_node.terminal_print_with_frame__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(graph_edge__terminal_print_with_frame, this, terminal_print_frame, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_graph_edge.terminal_print_with_frame__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(graph__terminal_print_with_frame, this, terminal_print_frame, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_graph.terminal_print_with_frame__funk = never_gc(cfunk);}
