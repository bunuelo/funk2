...
f2ptr raw__load(f2ptr cause, f2ptr thread, f2ptr filename) {
  ...
  f2ptr load_funk     = f2funk__new(cause, nil, nil, f2cons__new(cause, nil, nil), nil, global_environment(), nil);
  ...
  while (read_exp != __end_of_file_exception) {
	...
	load_funk     = f2funk__new(cause, nil, nil, f2cons__new(cause, read_exp, nil), read_exp, global_environment(), nil);
