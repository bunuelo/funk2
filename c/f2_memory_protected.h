...
#else
#  error SWAP_MEMORY or STATIC_MEMORY must be defined.
#endif
...
#define   __ptr__pool_address(pool_index, p) ((u64)(((u64)(p)) - (u64)(__funk2.memory.pool[pool_index].global_f2ptr_offset)) & (u64)(f2ptr__pool_address__max_value))
