...
typedef void (*funk2_module_registration_defragmenter_fix_pointers_function_ptr_t)();
...
typedef struct funk2_module_registration_node_s {
  ...
  funk2_module_registration_defragmenter_fix_pointers_function_ptr_t defragment_fix_pointers_function;
