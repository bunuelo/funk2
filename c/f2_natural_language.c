...
def_frame_object__global__8_slot(clause, symbols, secondary, imperative, declarative, question, yes_no, wh, particle);
...
f2ptr f2__clause__new(f2ptr cause) {
  ...
  f2ptr wh          = nil;
  f2ptr particle    = nil;
  return f2clause__new(cause, symbols, secondary, imperative, declarative, question, yes_no, wh, particle);
}
...
void f2__natural_language__initialize() {
  ...
  init_frame_object__8_slot(clause, symbols, secondary, imperative, declarative, question, yes_no, wh, particle);
