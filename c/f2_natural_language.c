...
def_frame_object__global__1_slot(thing_pronoun_word, symbol);

f2ptr f2__thing_pronoun_word__new(f2ptr cause, f2ptr symbol) {
  return f2thing_pronoun_word__new(cause, symbol);
}
def_pcfunk1(thing_pronoun_word__new, symbol, return f2__thing_pronoun_word__new(this_cause, symbol));
...
void f2__natural_language__initialize() {
  ...
  init_frame_object__1_slot(thing_pronoun_word, symbol);
