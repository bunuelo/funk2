...
void f2__nil__initialize() {
  ...
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(nil__as__string, this, cfunk, 1, "returns the string '[]'."); __funk2.globalenv.object_type.nil_type.as__string__funk = never_gc(cfunk);}
