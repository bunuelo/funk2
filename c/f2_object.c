...
void object_lattice__mapc_relations__object_slot_helper(f2ptr cause, f2ptr slot_name, f2ptr aux_data) {
  ...
  
  {
    ...
    f2ptr relation_scan_result = object_lattice__mapc_relations__relation_scan(cause, fiber, node_funk, relation_funk, object, this, start_nanoseconds_since_1970, slot_name, slot_value);
    ...
    //f2ptr mapc_relations_result = f2__object_lattice__mapc_relations(cause, fiber, this, slot_value, node_funk, relation_funk, start_nanoseconds_since_1970);
...
void object_lattice__mapc_relations__frame_slot_helper(f2ptr cause, f2ptr slot_name, f2ptr aux_data) {
  f2ptr fiber                        = raw__array__elt(cause, aux_data, 0);
  f2ptr node_funk                    = raw__array__elt(cause, aux_data, 1);
  f2ptr relation_funk                = raw__array__elt(cause, aux_data, 2);
...
f2ptr f2__object_lattice__mapc_relations__expand_node__primobject_slots(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr object, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  ...
  {
    f2ptr aux_data = raw__array__new(cause, 7);
    ...
    raw__array__elt__set(cause, aux_data, 6, found_larva);
    raw__primobject_type__type_funk__mapc_slot_names(cause, object_type, __funk2.globalenv.get__symbol, &object_lattice__mapc_relations__object_slot_helper, aux_data);
    found_larva = raw__array__elt(cause, aux_data, 6);
  }
  return found_larva;
}

f2ptr f2__object_lattice__mapc_relations__expand_node__frame_slots(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr frame, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  f2ptr found_larva = nil;
  {
    f2ptr aux_data = raw__array__new(cause, 7);
    raw__array__elt__set(cause, aux_data, 0, fiber);
    ...
    raw__array__elt__set(cause, aux_data, 5, start_nanoseconds_since_1970);
    raw__array__elt__set(cause, aux_data, 6, found_larva);
    raw__frame__type_var__mapc_slot_names(cause, frame, __funk2.globalenv.get__symbol, &object_lattice__mapc_relations__frame_slot_helper, aux_data);
    found_larva = raw__array__elt(cause, aux_data, 6);
  }
  return found_larva;
}

f2ptr f2__object_lattice__mapc_relations__expand_node__array_indices(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr array, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  u64 length = raw__array__length(cause, array);
  u64 index;
  for (index = 0; index < length; index ++) {
    f2ptr element = raw__array__elt(cause, array, index);
    return f2__object_lattice__mapc_relations(cause, fiber, this, element, node_funk, relation_funk, start_nanoseconds_since_1970);
  }
  return nil;
}

f2ptr f2__object_lattice__mapc_relations__expand_node(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr object, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  if      (raw__typedframe__is_type(cause, object)) {return f2__object_lattice__mapc_relations__expand_node__primobject_slots(cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  else if (raw__frame__is_type(     cause, object)) {return f2__object_lattice__mapc_relations__expand_node__frame_slots(     cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  else if (raw__primobject__is_type(cause, object)) {return f2__object_lattice__mapc_relations__expand_node__primobject_slots(cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  else if (raw__array__is_type(     cause, object)) {return f2__object_lattice__mapc_relations__expand_node__array_indices(   cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  return nil;
}

f2ptr f2__object_lattice__mapc_relations(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr object, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  ...
  if (! lattice_node) {
    ...
    return f2__object_lattice__mapc_relations__expand_node(cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);
  }
  return nil;
}
