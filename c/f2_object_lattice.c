...
f2ptr f2__object_lattice__scan_leafs__expand_node__frame_slots(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr frame, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  f2ptr found_larva = nil;
  {
    f2ptr aux_data = raw__array__new(cause, 7);
    raw__array__elt__set(cause, aux_data, 0, fiber);
...
f2ptr f2__object_lattice__scan_leafs__expand_node__array_indices(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr array, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  u64 length = raw__array__length(cause, array);
  u64 index;
  for (index = 0; index < length; index ++) {
    f2ptr element = raw__array__elt(cause, array, index);
...
f2ptr f2__object_lattice__scan_leafs__expand_node(f2ptr cause, f2ptr fiber, f2ptr this, f2ptr object, f2ptr node_funk, f2ptr relation_funk, f2ptr start_nanoseconds_since_1970) {
  if      (raw__typedframe__is_type(cause, object)) {return f2__object_lattice__scan_leafs__expand_node__primobject_slots(cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  else if (raw__frame__is_type(     cause, object)) {return f2__object_lattice__scan_leafs__expand_node__frame_slots(     cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  else if (raw__primobject__is_type(cause, object)) {return f2__object_lattice__scan_leafs__expand_node__primobject_slots(cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  else if (raw__array__is_type(     cause, object)) {return f2__object_lattice__scan_leafs__expand_node__array_indices(   cause, fiber, this, object, node_funk, relation_funk, start_nanoseconds_since_1970);}
  return nil;
}
