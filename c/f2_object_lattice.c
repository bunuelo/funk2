...
void object_lattice__scan_leafs__relation_scan(f2ptr cause, f2ptr fiber, f2ptr node_funk, f2ptr relation_funk, f2ptr object, f2ptr this, f2ptr start_nanoseconds_since_1970, f2ptr slot_name, f2ptr slot_value) {
  f2__force_funk_apply(cause, fiber, relation_funk, f2cons__new(cause, object, f2cons__new(cause, slot_name, f2cons__new(cause, slot_value, nil))));
}
