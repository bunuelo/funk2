...
typedef enum funk2_packet_type_e {
  ...
  funk2_packet_type__pcs_request__f2ptype__creation_nanoseconds_since_1970   , //f2ptr            (f2ptr cause, f2ptr this);
  funk2_packet_type__pcs_respond__f2ptype__creation_nanoseconds_since_1970   ,
...
//  funk2_packet_type__pcs_request__f2ptype__creation_nanoseconds_since_1970                                 = 0x06, //ptype_t          (f2ptr cause, f2ptr this);

// request f2ptype__creation_nanoseconds_since_1970

struct pcs_packet_payload_request__f2ptype__creation_nanoseconds_since_1970_s {
  pcs_packet_payload_header__action_payload_header_t action_payload_header;
  f2ptr                                              this;
} __attribute__((__packed__));
typedef struct pcs_packet_payload_request__f2ptype__creation_nanoseconds_since_1970_s pcs_packet_payload_request__f2ptype__creation_nanoseconds_since_1970_t;

struct pcs_request__f2ptype__creation_nanoseconds_since_1970_s {
  funk2_packet_header_t                                                  header;
  pcs_packet_payload_request__f2ptype__creation_nanoseconds_since_1970_t payload;
} __attribute__((__packed__));
typedef struct pcs_request__f2ptype__creation_nanoseconds_since_1970_s pcs_request__f2ptype__creation_nanoseconds_since_1970_t;

// respond f2ptype__creation_nanoseconds_since_1970

struct pcs_packet_payload_respond__f2ptype__creation_nanoseconds_since_1970_s {
  pcs_packet_payload_header__action_payload_header_t action_payload_header;
  u64                                                creation_nanoseconds_since_1970;
} __attribute__((__packed__));
typedef struct pcs_packet_payload_respond__f2ptype__creation_nanoseconds_since_1970_s pcs_packet_payload_respond__f2ptype__creation_nanoseconds_since_1970_t;

struct pcs_respond__f2ptype__creation_nanoseconds_since_1970_s {
  funk2_packet_header_t                                                  header;
  pcs_packet_payload_respond__f2ptype__creation_nanoseconds_since_1970_t payload;
} __attribute__((__packed__));
typedef struct pcs_respond__f2ptype__creation_nanoseconds_since_1970_s pcs_respond__f2ptype__creation_nanoseconds_since_1970_t;
