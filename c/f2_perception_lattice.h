...
declare_object_type_2_slot(perception_graph, edges_node_hash, edge_structure_hash_value, );
...
// perception_graph
declare_primobject_2_slot(perception_graph, edges_node_hash, edge_structure_hash_value);
