...
declare_object_type_1_slot(physical_scene, background_texture, physical_objects, );
...
declare_primobject_1_slot(physical_scene, background_texture, physical_objects);
