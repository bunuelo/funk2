...
declare_object_type_4_slot(physical_object, transform, text, texture_name, part_place_frame, );
...
declare_primobject_4_slot(physical_object, transform, text, texture_name, part_place_frame);
