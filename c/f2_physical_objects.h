...
declare_object_type_4_slot(physical_object, transform, text, texture_name, part_frame, );
...
declare_primobject_3_slot(physical_object, transform, text, texture_name, part_frame);
