...
declare_object_type_4_slot(physical_object, position, rotation, texture_name, size, );
...
declare_primobject_4_slot(physical_object, position, rotation, texture_name, size);
