...
declare_object_type_5_slot(physical_object, transform, text, texture_name, part_place_frame, agent, );
...
declare_primobject_5_slot(physical_object, transform, text, texture_name, part_place_frame, agent);
