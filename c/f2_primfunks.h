...
#define f2__primcfunk__init__with_c_cfunk_var(name, c_cfunk_var, is_funktional) \
  f2ptr c_cfunk_var = f2cfunk__new(initial_cause(), def_pcfunk__symbolvar(name), nil, f2pointer__new(initial_cause(), to_ptr(def_pcfunk__funkvar(name))), global_environment(), (is_funktional) ? __funk2.globalenv.true__symbol : nil); \
  { \
