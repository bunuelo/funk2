...
def_pcfunk3(f2__fcntl, fd, cmd, value,
	    "",
...
def_pcfunk2(f2__fcntl__getfd, fd, value,
	    "",
...
def_pcfunk2(f2__fcntl__setfd, fd, value,
	    "",
...
def_pcfunk2(f2__fcntl__getfl, fd, value,
	    "",
...
def_pcfunk2(f2__fcntl__setfl, fd, value,
	    "",
