...
f2ptr raw__fiber_trigger__remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex(f2ptr cause, f2ptr this, f2ptr fiber, f2ptr traced_cmutex) {
  f2ptr this__cmutex = assert_value(f2__fiber_trigger__cmutex(cause, this));
  raw__cmutex__lock(cause, this__cmutex);
  f2ptr result = raw__fiber_trigger__add_waiting_fiber_and_remove_from_scheduler__thread_unsafe(cause, this, fiber);
  if (raw__larva__is_type(cause, result)) {
  ...
  raw__traced_cmutex__unlock(cause, traced_cmutex);
  raw__cmutex__unlock(cause, this__cmutex);
  return nil;
}

f2ptr f2__fiber_trigger__remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex(f2ptr cause, f2ptr this, f2ptr fiber, f2ptr traced_cmutex) {
  assert_argument_type(fiber_trigger, this);
  assert_argument_type(fiber,         fiber);
  assert_argument_type(traced_cmutex, traced_cmutex);
  return raw__fiber_trigger__remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex(cause, this, fiber, traced_cmutex);
}
def_pcfunk3(fiber_trigger__remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex, this, fiber, traced_cmutex,
	    "",
	    return f2__fiber_trigger__remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex(this_cause, this, fiber, traced_cmutex));
...
f2ptr f2fiber_trigger__primobject_type__new_aux(f2ptr cause) {
  ...
  {char* slot_name = "remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex";             f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "execute"), new__symbol(cause, slot_name), __funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex__funk);}
...
void f2__primobject__fiber_trigger__defragment__fix_pointers() {
  ...
  defragment__fix_pointer(__funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex__symbol);
  f2__primcfunk__init__defragment__fix_pointers(fiber_trigger__remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex);
  defragment__fix_pointer(__funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex__funk);
...
void f2__primobject__fiber_trigger__reinitialize_globalvars() {
  ...
  {char* symbol_str = "remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex"; __funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex__symbol = new__symbol(cause, symbol_str);}
  {f2__primcfunk__init__with_c_cfunk_var__3_arg(fiber_trigger__remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex, this, fiber, traced_cmutex, cfunk); __funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_and_unlock_traced_cmutex__funk = never_gc(cfunk);}
