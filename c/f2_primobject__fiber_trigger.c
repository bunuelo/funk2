...
f2ptr raw__fiber_trigger__remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other(f2ptr cause, f2ptr this, f2ptr fiber, f2ptr traced_cmutex, f2ptr other) {
  ...
  raw__cmutex__unlock(cause, this__cmutex);
  raw__fiber_trigger__trigger(cause, other);
  return nil;
}
...
f2ptr f2__fiber_trigger__remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other(f2ptr cause, f2ptr this, f2ptr fiber, f2ptr traced_cmutex, f2ptr other) {
  ...
  assert_argument_type(fiber,         fiber);
  assert_argument_type(traced_cmutex, traced_cmutex);
  assert_argument_type(fiber_trigger, other);
  return raw__fiber_trigger__remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other(cause, this, fiber, traced_cmutex, other);
}
def_pcfunk4(fiber_trigger__remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other, this, fiber, traced_cmutex, other,
	    "",
	    return f2__fiber_trigger__remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other(this_cause, this, fiber, traced_cmutex, other));
...
f2ptr f2fiber_trigger__primobject_type__new_aux(f2ptr cause) {
  ...
  {char* slot_name = "remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other";             f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "execute"), new__symbol(cause, slot_name), __funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other__funk);}
...
void f2__primobject__fiber_trigger__defragment__fix_pointers() {
  ...
  defragment__fix_pointer(__funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other__symbol);
  f2__primcfunk__init__defragment__fix_pointers(fiber_trigger__remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other);
  defragment__fix_pointer(__funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other__funk);
...
void f2__primobject__fiber_trigger__reinitialize_globalvars() {
  ...
  {char* symbol_str = "remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other"; __funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other__symbol = new__symbol(cause, symbol_str);}
  {f2__primcfunk__init__with_c_cfunk_var__4_arg(fiber_trigger__remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other, this, fiber, traced_cmutex, other, cfunk); __funk2.globalenv.object_type.primobject.primobject_type_fiber_trigger.remove_from_scheduler_add_waiting_fiber_unlock_traced_cmutex_and_trigger_other__funk = never_gc(cfunk);}
