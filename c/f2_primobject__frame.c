...
void f2__primobject_frame__initialize() {
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__key_types, this, var, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.key_types__funk = never_gc(cfunk);}
