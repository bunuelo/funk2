...
def_pcfunk2(frame__contains, this, var, return f2__frame__contains(this_cause, this, var));
...
def_pcfunk2(frame__type_var__keys, this, type, return f2__frame__type_var__keys(this_cause, this, type));
...
def_pcfunk2(frame__type_var__values, this, type, return f2__frame__type_var__values(this_cause, this, type));
...
def_pcfunk1(frame__var__keys, this, return f2__frame__var__keys(this_cause, this));
...
def_pcfunk3(frame__copy_slots, this, source, map_keys, return f2__frame__copy_slots(this_cause, this, source, map_keys));
...
void f2__primobject_frame__initialize() {
  ...
  {f2__primcfunk__init__with_c_cfunk_var__4_arg(frame__add_type_var_value, this, type, var, value, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.add_type_var_value__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__4_arg(frame__lookup_type_var_assignment_cons, this, type, var, not_defined_value, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.lookup_type_var_assignment_cons__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__4_arg(frame__lookup_type_var_value, this, type, var, not_defined_value, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.lookup_type_var_value__funk = never_gc(cfunk);}
  {char* symbol_str = "contains_type_var"; __funk2.globalenv.object_type.primobject.primobject_type_frame.contains_type_var__symbol = f2symbol__new(cause, strlen(symbol_str), (u8*)symbol_str);}
  {f2__primcfunk__init__with_c_cfunk_var__3_arg(frame__contains_type_var, this, type, var, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.contains_type_var__funk = never_gc(cfunk);}
  {char* symbol_str = "contains"; __funk2.globalenv.object_type.primobject.primobject_type_frame.contains__symbol = f2symbol__new(cause, strlen(symbol_str), (u8*)symbol_str);}
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__contains, this, var, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.contains__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__5_arg(frame__type_var_value__set, this, type, var, value, not_defined_value, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.type_var_value__set__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__type_var__keys, this, type, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.type_var__keys__funk = never_gc(cfunk);}
  {char* symbol_str = "key_types"; __funk2.globalenv.object_type.primobject.primobject_type_frame.key_types__symbol = f2symbol__new(cause, strlen(symbol_str), (u8*)symbol_str);}
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(frame__key_types, this, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.key_types__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__type_var__values, this, type, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.type_var__values__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__copy, this, source, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.copy__funk = never_gc(cfunk);}
  {char* symbol_str = "new_copy"; __funk2.globalenv.object_type.primobject.primobject_type_frame.new_copy__symbol = f2symbol__new(cause, strlen(symbol_str), (u8*)symbol_str);}
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(frame__new_copy, this, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.new_copy__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__3_arg(frame__copy_slots, this, source, map_keys, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.copy_slots__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__3_arg(frame__check_has_type_slot, this, type_name, slot_name, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.check_has_type_slot__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__equals_hash_value__loop_free, this, node_hash, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.equals_hash_value__loop_free__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(frame__equals_hash_value, this, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.equals_hash_value__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__part_not_contained_by, this, that, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.part_not_contained_by__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__3_arg(frame__add_to_graph_with_ptypehash, this, graph, node_ptypehash, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.add_to_graph_with_ptypehash__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__terminal_print_with_frame, this, terminal_print_frame, cfunk, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.terminal_print_with_frame__funk = never_gc(cfunk);}
