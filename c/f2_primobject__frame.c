...
f2ptr raw__frame__add_to_graph_with_ptypehash(f2ptr cause, f2ptr this, f2ptr graph, f2ptr node_ptypehash) {
  ...
  if (this_node == nil) {
    ...
    frame__iteration(cause, this, type_slot_name, slot_name, slot_value,
		     ...
		     f2__graph__add_new_edge(cause, graph, type_slot_name, slot_value_node, f2__graph_node__new(cause, slot_type));
		     );
...
void f2__primobject_frame__initialize() {
  ...
  {f2__primcfunk__init__with_c_cfunk_var__3_arg(frame__contains_type_var, this, type, var, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.contains_type_var__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__2_arg(frame__contains, this, var, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.contains__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(frame__key_types, this, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.key_types__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(frame__new_copy, this, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.new_copy__funk = never_gc(cfunk);}
  ...
  {f2__primcfunk__init__with_c_cfunk_var__3_arg(frame__copy_slots, this, source, map_keys, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_frame.copy_slots__funk = never_gc(cfunk);}
