...
declare_object_type_4_slot(frame, write_cmutex, read_cmutex, read_count, type_ptypehash,
...
declare_primobject_4_slot(frame, write_cmutex, read_cmutex, read_count, type_ptypehash);
