...
void f2__primobject__matrix__reinitialize_globalvars() {
  ...
  {char* symbol_str = "elt"; __funk2.globalenv.object_type.primobject.primobject_type_matrix.elt__symbol = new__symbol(cause, symbol_str);}
  ...
  {char* symbol_str = "elt-set"; __funk2.globalenv.object_type.primobject.primobject_type_matrix.elt__set__symbol = new__symbol(cause, symbol_str);}
