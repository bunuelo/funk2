...
bool raw__objectp(f2ptr this, f2ptr cause) {return raw__arrayp(this, cause) && f2primobject__is_object(this, cause);}
...
f2ptr object__lookup_local_type_var_assignment_cons(f2ptr cause, f2ptr this, f2ptr type, f2ptr var) {
  return frame__lookup_type_var_assignment_cons(cause, f2object__frame(this, cause), type, var);
}
