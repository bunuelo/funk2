...
declare_object_type_6_slot(ptypehash, write_cmutex, read_cmutex, read_count, key_count, bin_num_power, bin_array,
...
declare_primobject_6_slot(ptypehash, write_cmutex, read_cmutex, read_count, key_count, bin_num_power, bin_array);
