...
declare_object_type_4_slot(scheduler_ptypehash, scheduler_creadwritelock, key_count, bin_num_power, bin_array,
...
declare_primobject_4_slot(scheduler_ptypehash, scheduler_creadwritelock, key_count, bin_num_power, bin_array);
...
#define raw__scheduler_ptypehash__double_size__thread_unsafe(cause, this) raw__scheduler_ptypehash__double_size__thread_unsafe__debug(cause, this, (char*)__FILE__, __LINE__, (char*)__FUNCTION__)
