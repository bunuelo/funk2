...
f2ptr f2set__primobject_type__new(f2ptr cause) {
  ...
  {char* slot_name = "write_mutex";   f2__primobject_type__add_slot(cause, this, f2symbol__new(cause, strlen(slot_name), (u8*)slot_name),
								    __funk2.globalenv.object_type.primobject.primobject_type_set.write_mutex__funk,   __funk2.globalenv.object_type.primobject.primobject_type_set.write_mutex__set__funk, nil);}
  {char* slot_name = "key_count";     f2__primobject_type__add_slot(cause, this, f2symbol__new(cause, strlen(slot_name), (u8*)slot_name),
								    __funk2.globalenv.object_type.primobject.primobject_type_set.key_count__funk,     __funk2.globalenv.object_type.primobject.primobject_type_set.key_count__set__funk, nil);}
