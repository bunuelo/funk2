...
def_pcfunk6(stream__new, type, ungetc_stack, rewind_stack, rewindable, file_descriptor, string, index, return f2__stream__new(this_cause, type, ungetc_stack, rewind_stack, rewindable, file_descriptor, string, index));
