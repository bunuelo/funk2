...
void funk2_primobject_type_handler__add_builtin_primobjects(funk2_primobject_type_handler_t* this, f2ptr cause) {
  ...
  {char* type_name = "doublelinklist";        funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),        f2doublelinklist__primobject_type__new(cause));}
  ...
  {char* type_name = "funkhash";              funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),              f2funkhash__primobject_type__new_aux(cause));}
  ...
  {char* type_name = "perception_graph_edge"; funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name), f2perception_graph_edge__primobject_type__new(cause));}
  {char* type_name = "perception_graph";      funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),      f2perception_graph__primobject_type__new(cause));}
