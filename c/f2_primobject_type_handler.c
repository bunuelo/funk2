...
void funk2_primobject_type_handler__add_builtin_primobjects(funk2_primobject_type_handler_t* this, f2ptr cause) {
  ...
  {char* type_name = "fiber_trigger";                    funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),                    f2fiber_trigger__primobject_type__new_aux(cause));}
  ...
  {char* type_name = "redblacktree_node";                funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),                f2redblacktree_node__primobject_type__new_aux(cause));}
  {char* type_name = "interval_tree";                    funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),                    f2interval_tree__primobject_type__new_aux(cause));}
  {char* type_name = "interval_tree_node";               funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),               f2interval_tree_node__primobject_type__new_aux(cause));}
  ...
  {char* type_name = "package_handler";                  funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),                  f2package_handler__primobject_type__new_aux(cause));}
  ...
  {char* type_name = "optimize_bytecode";                funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),                f2optimize_bytecode__primobject_type__new_aux(cause));}
  {char* type_name = "optimize_chunk";                   funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),                   f2optimize_chunk__primobject_type__new_aux(cause));}
  {char* type_name = "optimize_transition";              funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),              f2optimize_transition__primobject_type__new_aux(cause));}
  ...
  {char* type_name = "matrix";                           funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),                           f2matrix__primobject_type__new_aux(cause));}
}
...
void funk2_primobject_type_handler__add_builtin_frame_objects(funk2_primobject_type_handler_t* this, f2ptr cause) {
  ...
  {char* type_name = "gtk_check_button";              funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),              f2gtk_check_button__primobject_type__new_aux(cause));}
  {char* type_name = "gtk_file_chooser_dialog";       funk2_primobject_type_handler__add_type(this, cause, f2symbol__new(cause, strlen(type_name), (u8*)type_name),       f2gtk_file_chooser_dialog__primobject_type__new_aux(cause));}
