...
f2ptr raw__cfunk__new(f2ptr cause, f2ptr name, f2ptr args, f2ptr stack_machine_code_pointer, f2ptr cfunkptr, f2ptr env, f2ptr is_funktional, f2ptr documentation) {
  return f2cfunk__new(cause, name, args, stack_machine_code_pointer, cfunkptr, env, is_funktional, documentation);
}

f2ptr f2__cfunk__new(f2ptr cause, f2ptr name, f2ptr args, f2ptr stack_machine_code_pointer, f2ptr cfunkptr, f2ptr env, f2ptr is_funktional, f2ptr documentation) {
  return raw__cfunk__new(cause, name, args, stack_machine_code_pointer, cfunkptr, env, is_funktional, documentation);
}
...
def_pcfunk1(funk__new_copy_in_this_environment, this,
	    "",
	    return f2__funk__new_copy_in_this_environment(this_cause, this));
...
f2ptr raw__bytecode__terminal_print_with_frame(f2ptr cause, f2ptr this, f2ptr terminal_print_frame) {
  ...
  f2ptr frame               = raw__ptypehash__lookup(cause, print_as_frame_hash, this);
  if (frame == nil) {
    f2ptr print_arg0 = f2__bytecode__arg0(cause, this);
    if (raw__cons__is_type(cause, print_arg0)) {
      print_arg0 = new__symbol(cause, "*");
    }
    f2ptr print_arg1 = f2__bytecode__arg1(cause, this);
    if (raw__cons__is_type(cause, print_arg1)) {
      print_arg1 = new__symbol(cause, "*");
    }
    f2ptr print_arg2 = f2__bytecode__arg2(cause, this);
    if (raw__cons__is_type(cause, print_arg2)) {
      print_arg2 = new__symbol(cause, "*");
    }
    frame = f2__frame__new(cause, f2list10__new(cause,
						new__symbol(cause, "print_object_type"), new__symbol(cause, "bytecode"),
						new__symbol(cause, "command"), f2__bytecode__command(cause, this),
						new__symbol(cause, "arg0"),    print_arg0,
						new__symbol(cause, "arg1"),    print_arg1,
						new__symbol(cause, "arg2"),    print_arg2));
    f2__ptypehash__add(cause, print_as_frame_hash, this, frame);
  }
  return raw__frame__terminal_print_with_frame(cause, frame, terminal_print_frame);
}
...
void f2__primobjects__defragment__fix_pointers() {
  ...
  defragment__fix_pointer(__funk2.globalenv.object_type.primobject.primobject_type_funk.new_copy_in_this_environment__symbol);
  f2__primcfunk__init__defragment__fix_pointers(funk__new_copy_in_this_environment);
  defragment__fix_pointer(__funk2.globalenv.object_type.primobject.primobject_type_funk.new_copy_in_this_environment__funk);
...
void f2__primobjects__reinitialize_globalvars() {
  ...
  {char* symbol_str = "new_copy_in_this_environment"; __funk2.globalenv.object_type.primobject.primobject_type_funk.new_copy_in_this_environment__symbol = new__symbol(cause, symbol_str);}
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(funk__new_copy_in_this_environment, this, cfunk); __funk2.globalenv.object_type.primobject.primobject_type_funk.new_copy_in_this_environment__funk = never_gc(cfunk);}
