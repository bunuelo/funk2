...
f2ptr f2__cause__lookup_type_var_value(f2ptr cause, f2ptr this, f2ptr type, f2ptr var) {
  ...
  do {
    ...
    if (cause_frame) {
      value = frame__lookup_type_var_value(cause, cause_frame, type, var, __funk2.primobject__frame.type_variable_not_defined__symbol);
    }
    if ((! cause_frame) || raw__symbol__eq(cause, value, __funk2.primobject__frame.type_variable_not_defined__symbol)) {
...
void f2__primobjects__initialize() {
  ...
  {f2__primcfunk__init__with_c_cfunk_var__1_arg(thread__sleep_until_time__get, this, cfunk, 0, "primobject_type funktion (defined in f2_primobjects.c)"); __funk2.globalenv.object_type.primobject.primobject_type_thread.sleep_until_time__get__funk = cfunk;}
