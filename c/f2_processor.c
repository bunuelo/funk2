...
f2ptr f2__processor__new(f2ptr cause) {
  return f2processor__new(cause, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil);
}
...
f2ptr f2processor__execute_next_bytecodes(f2ptr processor, f2ptr cause) {
  ...
  while (f2processor__active_fibers_iter(processor, cause)) {
	...
	pause_gc();
	f2processor__newly_paused_fibers__set(processor, cause, f2cons__new(cause, fiber, f2processor__newly_paused_fibers(processor, cause)));
	resume_gc();
      }
