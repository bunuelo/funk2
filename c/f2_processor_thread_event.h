...
#ifndef F2__PROCESSOR_THREAD_EVENT__TYPES__H
#define F2__PROCESSOR_THREAD_EVENT__TYPES__H

typedef struct funk2_processor_thread_event_s funk2_processor_thread_event_t;

#endif // F2__PROCESSOR_THREAD_EVENT__TYPES__H
