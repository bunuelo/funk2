...
f2ptr ptype_integer__new(int pool_index, f2ptr cause, s64 i) {
  ...
  if (__ptypes__creation_fiber_enabled) {
    ...
    initial__creation_fiber = creation_fiber;
  } else {
    initial__creation_fiber = nil;
  }
  ptype_block__init(&(integer_block->ptype), initial__cause, initial__creation_fiber);
...
f2ptr ptype_double__new(int pool_index, f2ptr cause, double d) {
  ...
  ptype_block__init(&(double_block->ptype), initial__cause, initial__creation_fiber);
  double_block->d = d;
  return double_f2ptr;
}
...
f2ptr ptype_float__new(int pool_index, f2ptr cause, float f) {
  ...
  ptype_block__init(&(float_block->ptype), initial__cause, initial__creation_fiber);
  float_block->f = f;
  return float_f2ptr;
}
...
f2ptr ptype_pointer__new(int pool_index, f2ptr cause, ptr p) {
  ...
  ptype_block__init(&(pointer_block->ptype), initial__cause, initial__creation_fiber);
  pointer_block->p = p;
...
f2ptr ptype_cmutex__new(int pool_index, f2ptr cause) {
  ...
  ptype_block__init(&(cmutex_block->ptype), initial__cause, initial__creation_fiber);
...
f2ptr ptype_creadwritelock__new(int pool_index, f2ptr cause) {
  ...
  ptype_block__init(&(creadwritelock_block->ptype), initial__cause, initial__creation_fiber);
...
f2ptr ptype_char__new(int pool_index, f2ptr cause, funk2_character_t ch) {
  ...
  ptype_block__init(&(char_block->ptype), initial__cause, initial__creation_fiber);
  char_block->ch = ch;
  return char_f2ptr;
}
...
f2ptr ptype_string__new(int pool_index, f2ptr cause, u64 length, funk2_character_t* str) {
  ...
  ptype_block__init(&(string_block->ptype), initial__cause, initial__creation_fiber);
...
f2ptr ptype_chunk__new(int pool_index, f2ptr cause, u64 length, byte* bytes) {
  ...
  ptype_block__init(&(chunk_block->ptype), initial__cause, initial__creation_fiber);
...
f2ptr ptype_cons__new(int pool_index, f2ptr cause, f2ptr car, f2ptr cdr) {
  ...
  ptype_block__init(&(cons_block->ptype), initial__cause, initial__creation_fiber);
  {
...
f2ptr ptype_simple_array__new(int pool_index, f2ptr cause, u64 length, ptr f2ptr_ptr) {
  ...
  ptype_block__init(&(simple_array_block->ptype), initial__cause, initial__creation_fiber);
...
f2ptr ptype_larva__new(int pool_index, f2ptr cause, u32 larva_type, f2ptr bug) {
  ...
  ptype_block__init(&(larva_block->ptype), initial__cause, initial__creation_fiber);
...
void funk2_symbol_hash__init(funk2_symbol_hash_t* this) {
  this->array = (funk2_atomic_u64_t*)from_ptr(f2__malloc(sizeof(funk2_atomic_u64_t) * SYMBOL_HASH__INITIAL_ARRAY_LENGTH));
  {
    ...
    for (index = 0; index < SYMBOL_HASH__INITIAL_ARRAY_LENGTH; index ++) {
      funk2_atomic_u64__init(&(this->array[index]), (u64)to_ptr(NULL));
    }
  }
...
void funk2_symbol_hash__add_symbol(funk2_symbol_hash_t* this, f2ptr symbol_f2ptr) {
  ...
  funk2_atomic_u64__init(&(new_node->next), 0);
  {
    boolean_t success = boolean__false;
    while (! success) {
      u64 old_value = funk2_atomic_u64__value(&(this->array[bin_index]));
      funk2_atomic_u64__set_value(&(new_node->next), old_value);
      success = funk2_atomic_u64__compare_and_swap(&(this->array[bin_index]), old_value, (u64)to_ptr(new_node));
    }
  }
}
...
f2ptr funk2_symbol_hash__lookup_symbol(funk2_symbol_hash_t* this, u64 length, funk2_character_t* str) {
  ...
  funk2_symbol_hash_node_t* node         = (funk2_symbol_hash_node_t*)from_ptr(funk2_atomic_u64__value(&(this->array[bin_index])));
  while (node != NULL) {
    ...
    node = (funk2_symbol_hash_node_t*)from_ptr(funk2_atomic_u64__value(&(node->next)));
  }
  return nil;
}
...
f2ptr funk2_symbol_hash__lookup_or_create_symbol(funk2_symbol_hash_t* this, int pool_index, f2ptr cause, u64 length, funk2_character_t* str) {
  f2ptr symbol_f2ptr = funk2_symbol_hash__lookup_symbol(this, length, str);
  if (symbol_f2ptr != nil) {
    return symbol_f2ptr;
  }
  ...
  ptype_block__init(&(symbol_block->ptype), initial__cause, initial__creation_fiber);
...
f2ptr funk2_symbol_hash__generate_new_random_symbol(funk2_symbol_hash_t* this, int pool_index, f2ptr cause, s64 initial_string_length, funk2_character_t* initial_string) {
  ...
  do {
    ...
    symbol_exists = funk2_symbol_hash__lookup_symbol(this, total_gensym_length, gensym__name);
  } while (symbol_exists);
  f2ptr new_symbol = funk2_symbol_hash__lookup_or_create_symbol(this, pool_index, cause, total_gensym_length, gensym__name);
  return new_symbol;
}
