...
void funk2_reader__init(funk2_reader_t* this) {
  ...
  {this->char__string_escape_newline   = f2char__new(cause, __string_escape_char);          char* str = "char:string_escape_newline";   environment__add_var_value(cause, global_environment(), f2symbol__new(cause, strlen(str), (u8*)str), this->char__string_escape_newline);}
  {this->char__string_escape_return    = f2char__new(cause, __string_escape_char);          char* str = "char:string_escape_return";    environment__add_var_value(cause, global_environment(), f2symbol__new(cause, strlen(str), (u8*)str), this->char__string_escape_return);}
  {this->char__string_escape_tab       = f2char__new(cause, __string_escape_char);          char* str = "char:string_escape_tab";       environment__add_var_value(cause, global_environment(), f2symbol__new(cause, strlen(str), (u8*)str), this->char__string_escape_tab);}
  {this->char__string_escape_backspace = f2char__new(cause, __string_escape_char);          char* str = "char:string_escape_backspace"; environment__add_var_value(cause, global_environment(), f2symbol__new(cause, strlen(str), (u8*)str), this->char__string_escape_backspace);}
