...
int f2__simple_repl(f2ptr cause, f2ptr fiber) {
  ...
  f2ptr repl_funk     = f2funk__new(cause, nil, nil, nil, f2cons__new(cause, nil, nil), nil, global_environment(), nil, nil, nil, nil);
  ...
  while (1) {
    ...
    if (raw__exception__is_type(cause, read_exp)) {
      ...
      repl_funk     = f2funk__new(cause, nil, nil, nil, f2cons__new(cause, read_exp, nil), read_exp, global_environment(), nil, nil, nil, nil);
