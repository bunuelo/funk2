...
void funk2_status(char* filename, int line_num, char* msg, ...) {
  ...
  char temp_msg2[2048];
  sprintf(temp_msg2, "\n[%-32s %5d] tid=0x" x64__fstr " 0x%X_%02d_%02d_%02d." nano_decimal_fraction__fstr " funk2 status: %s", filename, line_num, (u64)to_ptr(self_thread), (int)earth_rotations_since_1970, (int)hours, (int)minutes, (int)seconds, (u64)nanoseconds, temp_msg);
