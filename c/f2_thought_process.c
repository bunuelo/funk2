...
f2ptr f2thought_process__new_from_exp(f2ptr cause, f2ptr exp, f2ptr bin_num_power) {
  ...
  f2__hashtable__add_keyvalue_pair(cause, read_write_execute_slot_hash, __funk2.thought_process.real_value_slot__symbol, exp);
...
void f2__thought_process__read_write_execute__put(f2ptr cause, f2ptr this, f2ptr slot, f2ptr read_write_execute) {
  f2__hashtable__add_keyvalue_pair(cause, f2thought_process__read_write_execute_slot_hash(this, cause), slot, read_write_execute);
}
...
void f2__funk2_thought_process__add_type(f2ptr cause, f2ptr name, f2ptr thought_process_type) {
  f2__hashtable__add_keyvalue_pair(cause, __funk2.thought_process.global_thought_process_type_hash, name, thought_process_type);
}

f2ptr f2__funk2_thought_process__lookup_type(f2ptr cause, f2ptr name) {
  return f2__hashtable__lookup_value(__funk2.thought_process.global_thought_process_type_hash, cause, name);
}
...
void raw__read_write_execute_slot_hash__add_read_write_execute_slot(f2ptr cause, f2ptr this, char* slot_name, f2ptr read_funk, f2ptr write_funk, f2ptr execute_funk) {
  f2__hashtable__add_keyvalue_pair(cause, this, f2symbol__new(cause, strlen(slot_name), (u8*)slot_name), f2__read_write_execute__new(cause, read_funk, write_funk, execute_funk));
}
