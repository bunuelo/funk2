...
void* funk2_tricolor_set__black_set__mapc(funk2_set_t* this, void(* mapc_funk)(void** user_data, boolean_t* stop, void** return_value), void** user_data) {return funk2_set__mapc(&(this->black_set), mapc_funk, user_data);}
void* funk2_tricolor_set__white_set__mapc(funk2_set_t* this, void(* mapc_funk)(void** user_data, boolean_t* stop, void** return_value), void** user_data) {return funk2_set__mapc(&(this->white_set), mapc_funk, user_data);}
void* funk2_tricolor_set__grey_set__mapc( funk2_set_t* this, void(* mapc_funk)(void** user_data, boolean_t* stop, void** return_value), void** user_data) {return funk2_set__mapc(&(this->grey_set),  mapc_funk, user_data);}
