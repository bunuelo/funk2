...
void funk2_virtual_processor__init(funk2_virtual_processor_t* this, u64 index) {
  this->index = index;
  funk2_processor_spinlock__init(&(this->execute_bytecodes_mutex));
  {
    funk2_processor_spinlock__init(&(this->virtual_processor_thread_count_mutex));
    this->assigned_virtual_processor_thread_count = 0;
    this->spinning_virtual_processor_thread_count = 0;
  }
  {
    funk2_processor_spinlock__init(&(this->virtual_processor_thread_stack_mutex));
...
void funk2_virtual_processor__destroy(funk2_virtual_processor_t* this) {
  funk2_processor_spinlock__destroy(&(this->execute_bytecodes_mutex));
  funk2_processor_spinlock__destroy(&(this->virtual_processor_thread_count_mutex));
}
...
void funk2_virtual_processor__assure_at_least_one_spinning_virtual_processor_thread(funk2_virtual_processor_t* this) {
  ...
  {
    funk2_processor_spinlock__lock(&(this->virtual_processor_thread_count_mutex));
    spinning_virtual_processor_thread_count = this->spinning_virtual_processor_thread_count;
    funk2_processor_spinlock__unlock(&(this->virtual_processor_thread_count_mutex));
  }
  while (spinning_virtual_processor_thread_count < 1) {
    ...
    }
    {
      ...
      {
	funk2_processor_spinlock__lock(&(this->virtual_processor_thread_stack_mutex));
	...
	funk2_processor_spinlock__unlock(&(this->virtual_processor_thread_stack_mutex));
      }
...
boolean_t funk2_virtual_processor__already_executing_next_bytecodes(funk2_virtual_processor_t* this) {
  return funk2_processor_spinlock__is_locked(&(this->execute_bytecodes_mutex));
}
...
boolean_t funk2_virtual_processor__execute_next_bytecodes(funk2_virtual_processor_t* this, funk2_virtual_processor_thread_t* virtual_processor_thread) {
  ...
  if (locked_mutex) {
    funk2_processor_spinlock__unlock(&(this->execute_bytecodes_mutex));
  }
