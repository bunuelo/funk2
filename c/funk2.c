...
void funk2__init(funk2_t* this, int argc, char** argv) {
  ...
  funk2_virtual_processor_thread_handler__init(&(this->virtual_processor_thread_handler), memory_pool_num);
...
void funk2__destroy(funk2_t* this) {
  ...
  funk2_virtual_processor_thread_handler__destroy(&(this->virtual_processor_thread_handler));
}
