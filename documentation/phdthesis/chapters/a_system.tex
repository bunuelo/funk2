...
We trace the procenance of knowledge from perceptual knowledge as it
...
\section{A Parallel Process Representation}
...
\marginpar{Section~\ref{sec:learning_analogies_as_differences_of_differences}
  is referenced from Section~\ref{sec:learning_trans_frames_for_events}.}
