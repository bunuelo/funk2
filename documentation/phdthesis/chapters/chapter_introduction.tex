...
\begin{figure}[bth]
  \center
  \includegraphics[width=4cm]{gfx/perception_categorization}
  \caption[Learning to Approximate the Reward Function]{Learning to Approximate the Reward Function.}
