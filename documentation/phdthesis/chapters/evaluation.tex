...
\caption{The number of execution nodes and plan analogies that were
  made during in different stages of plans processing in the different
  planning layers during a typical planning scenario involving the
  super reflective layer interpreting and compiling a plan that
  becomes the reflective planning process, the reflective planning
  process interpreting, imagining and executing a reflective plan that
  becomes the deliberative planning process, and the deliberative
  layer interpreting, imagining and executing a plan that performs
  physical actions in the problem domain.}
