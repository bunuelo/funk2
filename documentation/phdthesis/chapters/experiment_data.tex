...
\newcommand{\experimentdatacaptionshort}[1]{Plots of time and memory
  requirements for the entire {#1}.}

\newcommand{\experimentdatatwocaptionshort}[1]{Plots of semantic
  knowledge counts for the entire {#1}.}

\newcommand{\experimentdatacaptionbegin}[1]{%
  \def\experimentdatacaptionbegincausegroupprettyname{#1}%
  All of the resources in the entire
  {\experimentdatacaptionbegincausegroupprettyname} have been causally
  traced and these two plots show: (top) the bytecode execution rate
  for the entire {\experimentdatacaptionbegincausegroupprettyname}, as
  well as (bottom) the memory footprint for the same causal scope.}

\newcommand{\experimentdatatwocaptionbegin}[1]{
  \def\experimentdatatwocaptionbegincausegroupprettyname{#1}%
  All of the resources in the entire
  {\experimentdatatwocaptionbegincausegroupprettyname} have been
  causally traced and these two plots show: (top) the semantic frame
  count for the entire
  {\experimentdatatwocaptionbegincausegroupprettyname}, as well as
  (bottom) the semantic frame slot value count for the same causal
  scope.}
...
{\newpage
  \noindent\begin{minipage}{\textwidth}
    ...
    \captionof{figure}[\experimentdatacaptionshort{AI}]{\experimentdatacaptionbegin{AI}}
  ...
  \noindent\begin{minipage}{\textwidth}
    ...
    \captionof{figure}[\experimentdatatwocaptionshort{AI}]{\experimentdatatwocaptionbegin{AI}}
  \label{figure:mind_plot-Gripper-1}
  \end{minipage}
}
%% % reflective
...
%%     \captionof{figure}[\experimentdatacaptionshort{Reflective
%%         Layer}]{\experimentdatacaptionbegin{Reflective Layer}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Reflective
%%         Layer}]{\experimentdatacaptionbegin{Reflective Layer}}
%%   \label{figure:mind_plot-Gripper-1-reflective}
%%   \end{minipage}
%% }
...
%%     \captionof{figure}[\experimentdatacaptionshort{Reflective Event
%%         Knowledge Agency}]{\experimentdatacaptionbegin{Reflective
%%         Event Knowledge Agency}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Reflective Event
%%         Knowledge Agency}]{\experimentdatacaptionbegin{Reflective
%%         Event Knowledge Agency}}
%%   \label{figure:mind_plot-Gripper-1-reflective-reflective_event_knowledge}
%%   \end{minipage}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Reflective
%%         Execution Agency}]{\experimentdatacaptionbegin{Reflective
%%         Execution Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Reflective
%%         Imagination Agency}]{\experimentdatacaptionbegin{Reflective
%%         Imagination Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Reflective
%%         Object-Type-Goal
%%         Agency}]{\experimentdatacaptionbegin{Reflective
%%         Object-Type-Goal Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Reflective Plan
%%         Agency}]{\experimentdatacaptionbegin{Reflective Plan Agency}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Reflective Plan
%%         Agency}]{\experimentdatacaptionbegin{Reflective Plan Agency}}
%%   \label{figure:mind_plot-Gripper-1-reflective-plan}
%%   \end{minipage}
%% }
...
%%     \captionof{figure}[\experimentdatacaptionshort{Reflective Plan-Bug-Response Agency}]{\experimentdatacaptionbegin{Reflective Plan-Bug-Response Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Deliberative
%%         Layer}]{\experimentdatacaptionbegin{Deliberative Layer}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Deliberative
%%         Layer}]{\experimentdatacaptionbegin{Deliberative Layer}}
%%   \label{figure:mind_plot-Gripper-1-deliberative}
%%   \end{minipage}
%% }
...
%%     \captionof{figure}[\experimentdatacaptionshort{Deliberative
%%         Execution Agency}]{\experimentdatacaptionbegin{Deliberative
%%         Execution Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Deliberative
%%         Imagination Agency}]{\experimentdatacaptionbegin{Deliberative
%%         Imagination Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Deliberative Object
%%         Type Goal Agency}]{\experimentdatacaptionbegin{Deliberative
%%         Object Type Goal Agency}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Deliberative Object
%%         Type Goal Agency}]{\experimentdatacaptionbegin{Deliberative
%%         Object Type Goal Agency}}
%%   \label{figure:mind_plot-Gripper-1-deliberative-physical_object_type_goal}
%%   \end{minipage}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Deliberative Plan
%%         Agency}]{\experimentdatacaptionbegin{Deliberative Plan
%%         Agency}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Deliberative Plan
%%         Agency}]{\experimentdatacaptionbegin{Deliberative Plan
%%         Agency}}
%%   \label{figure:mind_plot-Gripper-1-deliberative-plan}
%%   \end{minipage}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Learned Reactive
%%         Layer}]{\experimentdatacaptionbegin{Learned Reactive Layer}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Learned Reactive
%%         Layer}]{\experimentdatacaptionbegin{Learned Reactive Layer}}
%%   \label{figure:mind_plot-Gripper-1-learned_reactive}
%%   \end{minipage}
%% }
...
%%     \captionof{figure}[\experimentdatacaptionshort{Learned Reactive
%%         Physical Action Agency}]{\experimentdatacaptionbegin{Learned
%%         Reactive Physical Action Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Learned Reactive
%%         Physical-Knowledge
%%         Agency}]{\experimentdatacaptionbegin{Learned Reactive
...
%%     \captionof{figure}[\experimentdatacaptionshort{Built-in Reactive
%%         Layer}]{\experimentdatacaptionbegin{Built-in Reactive Layer}}
...
%%     \captionof{figure}[\experimentdatatwocaptionshort{Built-in Reactive
%%         Layer}]{\experimentdatacaptionbegin{Built-in Reactive Layer}}
%%   \label{figure:mind_plot-Gripper-1-builtin_reactive}
%%   \end{minipage}
%% }
...
%%     \captionof{figure}[\experimentdatacaptionshort{Built-in Reactive
%%         Neural Plug Agency}]{\experimentdatacaptionbegin{Built-in
%%         Reactive Neural Plug Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Built-in Reactive
%%         Physical Action Agency}]{\experimentdatacaptionbegin{Built-in
%%         Reactive Physical Action Agency}}
...
%%     \captionof{figure}[\experimentdatacaptionshort{Built-in Reactive
%%         Sensory Agency}]{\experimentdatacaptionbegin{Built-in Reactive
%%         Sensory Agency}}
