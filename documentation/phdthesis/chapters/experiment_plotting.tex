...
\newcommand\experimentcausegroupplotscontinued[5]{%
  ...
  \subsection{\experimentcausegroupplotscausegroupprettyname}
    \begin{tabular}{r}
      {\raggedleft
    ...
    \end{tabular}
    \captionof{figure}[Plots for {\experimentcausegroupplotscausegroupprettyname}.]{All of the resources in the entire
       {\experimentcausegroupplotscausegroupprettyname} have been
       causally traced and these two plots show: (top) the bytecode
       execution rate for the entire
       {\experimentcausegroupplotscausegroupprettyname}, as well as
       (bottom) the memory footprint of the same causal scope.
       {\experimentcausegroupplotsexperimentdescription}}
...
\newcommand{\dataappendixmaxtime}{22.75}
