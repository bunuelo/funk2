...
\newcommand{\causegroupplotscollection}[5][]{
  ...
  \ifthenelse{\lengthtest{0.01 pt > \experimentmaxvalue pt}}{
    ...
    \begin{tikzpicture}[y=2.5cm/\experimentmaxvalue, x=8cm/#1,font=\sffamily]
      ...
      \experimentdatalegendthree[#1]{\experimentmaxvalue}{#4-bytes_freed_count.data}{#5};
    \end{tikzpicture}
  }
}
...
\newcommand{\causegroupplotsmemory}[5][]{
  ...
  \ifthenelse{\lengthtest{0.01 pt > \experimentmaxvalue pt}}{
    ...
    \begin{tikzpicture}[y=2.5cm/\experimentmaxvalue, x=8cm/#1,font=\sffamily]
      ...
      \experimentdatalegendfour[#1]{\experimentmaxvalue}{#4-bytes_footprint.data}{#5};
    \end{tikzpicture}
  }
}
...
\newcommand{\experimentAIdatafigures}[3][]{
...
\newcommand{\experimentdatafigures}[3][]{
  % AI
  {\clearpage
    \experimentAIdatafigures[#1]{#2}{#3 {\mbox{\autoref{table:#2}}} on
      {\mbox{page~\pageref{table:#2}}} shows an index of other data
      from this experiment.}
  }                                                            
  % reflective
  {\clearpage
