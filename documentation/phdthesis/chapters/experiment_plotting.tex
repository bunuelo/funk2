...
\newcommand{\experimentdataone}[3][]{
  ...
  \begin{scope}
    ...
    \draw[color=experimentdataonecolor] plot[mark=*, mark options={fill=white,draw=experimentdataonecolor,scale=\experimentmarkscalefour}]
      file {#3};
  \end{scope}
}
...
\newcommand{\experimentdatatwo}[3][]{
  ...
  \begin{scope}
    ...
    \draw[color=experimentdatatwocolor] plot[mark=square*, mark options={fill=white,draw=experimentdatatwocolor,scale=\experimentmarkscaletwo}]
      file {#3};
  \end{scope}
}
...
\newcommand{\experimentdatathree}[3][]{
  ...
  \begin{scope}
    ...
    \draw[color=experimentdatathreecolor] plot[mark=triangle*, mark options={fill=white,draw=experimentdatathreecolor,scale=\experimentmarkscalethree}]
      file {#3};
  \end{scope}
}
...
\newcommand{\experimentdatafour}[3][]{
  ...
  \begin{scope}
    ...
    \draw[color=experimentdatafourcolor] plot[mark=square*, mark options={fill=experimentdatafourcolor,draw=experimentdatafourcolor,scale=\experimentmarkscaleone}]
      file {#3};
  \end{scope}
}
...
\newcommand{\experimentdatafive}[3][]{
  ...
  \begin{scope}
    ...
    \draw[color=experimentdatafivecolor] plot[mark=triangle*, mark options={fill=experimentdatafivecolor,draw=experimentdatafivecolor,scale=\experimentmarkscalefive}]
      file {#3};
  \end{scope}
}
...
\newcommand{\experimentyaxisbytecodes}{
  \node[rotate=90, above=1.4cm] at (y axis mid) {Execution Rate};
...
\newcommand{\causegroupplotsexecutioncontinued}[1]{
  ...
  \ifthenelse{\lengthtest{0.01 pt > \causegroupplotsexecutionexperimentmaxvalue pt}}{
    ...
    \begin{tikzpicture}[y=\causegroupplotsexecutionplotheight/\causegroupplotsexecutionexperimentmaxvalue, x=8cm/\causegroupplotsexecutionplotmaxtime,font=\sffamily]
      ...
      \experimentlegendthree[\causegroupplotsexecutionplotmaxtime * 1 / 10]{\causegroupplotsexecutionexperimentmaxvalue * 11 / 10}{Deliberative and Reflective Learning};
      \experimentlegendtwo[\causegroupplotsexecutionplotmaxtime * 1 / 10]{\causegroupplotsexecutionexperimentmaxvalue * 10 / 10}{Only Deliberative Learning};
      \experimentlegendone[\causegroupplotsexecutionplotmaxtime * 1 / 10]{\causegroupplotsexecutionexperimentmaxvalue * 9 / 10}{Boot-up and Perceive without Goals};
...
\newcommand{\dataappendixmaxtime}{20}
\newcommand{\dataappendixexperimentonemaxtime}{20}
\newcommand{\dataappendixexperimenttwomaxtime}{20}
\newcommand{\dataappendixexperimentthreemaxtime}{20}
