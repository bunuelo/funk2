...
\begin{figure}[bth]
  ...
  \caption[Isis World is a larger real-time symbolic control problem
    than the Blocks World toy problem.]{Isis World is a larger
    real-time symbolic control problem, which we use to demonstrate
    that our reflective learning aproach scales to larger state spaces
    and to slightly more complicated learning problems.}
