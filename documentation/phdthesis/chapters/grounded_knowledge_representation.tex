%************************************************
\chapter{Grounded Knowledge Representation}
\label{chapter:grounded_knowledge_representation}
%************************************************
...
Causal knowledge in the first-order reflective layer is the ground
truth for all other hypothetical abstractions in the first-order
reflective layer.  {\mbox{\autoref{figure:example_causal_knowledge}}}
shows an example of causal knowledge.
\begin{figure}
\center
