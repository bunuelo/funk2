...
Now that I have described grounded factual knowledge that has an
unquestionable basis in the dynamic, ``pre-symbolic'', actually
continuous Space of activities in Duration, hypothetical knowledge can
be abstracted from these facts.
