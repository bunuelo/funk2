...
\item \emph{Grounded Learning of Knowledge Utility}: A dependency
  ...
  ``being told'' as well as from experience.  New experiences allow
  the AI to learning what types of knowledge are useful in different
  contexts by refining reflective hypotheses about whether or not
  plans will lead to the successful accomplishment of goals or to
  different potential types of failures during execution.
...
algorithm below. I see metacognition as a layering of learning
algorithms, such that the second layer algorithm learns from
