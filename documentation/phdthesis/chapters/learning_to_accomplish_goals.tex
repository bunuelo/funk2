...
system uses.  These four types of knowledge are, briefly:

\begin{enumerate}

\item{Goal-action physical causal hypotheses: focuses and constrains
  the initial action learning search.}
...
\subsection{Goal-Action Physical Causal Hypotheses}


\subsection{Action Physical Precondition Goal Occurrence Hypotheses}


\subsection{Action Physical Precondition Trans-Frame Hypotheses}


\subsection{Physical Hypotheses for Predicting Goal Occurrence}
