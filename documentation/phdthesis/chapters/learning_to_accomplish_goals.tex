...
\section{Learning to Plan Four-Step Cycle}

\begin{figure}[bth]
  \center
  \includegraphics[width=11cm]{gfx/learning_to_plan-four_step_cycle}
  \caption[Learning to plan four step cycle]{Learning to plan four step cycle.}
  \label{fig:learning_to_plan-four_step_cycle}
\end{figure}

See Figure~\ref{fig:learning_to_plan-four_step_cycle}.
