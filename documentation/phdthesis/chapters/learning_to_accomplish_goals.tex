...
\subsection{Goal-Oriented Action Hypotheses}
...
\subsection{Action Precondition Goal Occurrence Hypotheses}
...
\begin{figure}[bth]
  ...
  \caption[Action precondition goal occurrence hypotheses]{Action
    precondition goal occurrence hypotheses are a form of knowledge
    that is learned in order to predict whether or not a goal will be
    occurring if a given action is taken in a given conceptual
    category of a given abstraction of the state space.}
...
\subsection{Action Precondition Trans-Frame Hypotheses}
