...
in Figure~\ref{fig:learning_to_plan}.  It is important not to confuse
these.  The first kind of time are the times associated with the
...
figure.  The first kind of time is represented and labelled as the
horizontal axis of the figure.  The second kind of time represented in
the figure is the enumeration of the four learning steps.

In the following four sections, we will describe the utility of each
of these four different types of knowledge in more detail.
...
\section{Action Physical Precondition Goal Occurrence Hypotheses}
