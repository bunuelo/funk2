...
fulfills our purpose of an introductory explanation, see
Section~\ref{sec:what_is_a_computer} for discussion about approaching
more realistic models computation that include more of the beautiful
engineering details of controlling modern computer hardware systems.
