...
continuity.  It is important to understand that using an infinite
number of symbols does not make the model actually continuous.  A
model that includes an infinite number of symbols, like the
mathematician's real number line, does not magically make this model
not fundamentally discrete and symbolic.
...
dynamic activities.  A reflective AI, therefore, must explicitly be
based on the relationship between its own goals and the problem of
creating relevant models of its own dynamic activity.  In other words,
a reflective AI, must explicitly be programmed to learn when a given
