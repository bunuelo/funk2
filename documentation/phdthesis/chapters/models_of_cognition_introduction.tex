...
\begin{figure}[bth]
  ...
  \caption[Learning to plan toward goals]{Learning to plan toward goals is naturally represented in a reflective event representation.}
...
\marginpar{The agent is not necessarily currently planning toward or
  otherwise intending to pursue the goal in this example.  Here, the
  goal is simply a learning goal.}
