...
\begin{figure}[bth]
  \center
  \includegraphics[width=10cm]{gfx/serial_and_parallel_plan}
...
The partially-ordered plan representation is a general ways to
temporally organize a set of commands.
Figure~\ref{fig:serial_and_parallel_plan} shows a plan representation
that demonstrates a branch and a join control structure as represented
as a partially-ordered plan.
