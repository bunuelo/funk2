...
through the environment process.  We base our understanding of
communication on Shannon's mathmematical theory~\citep{shannon1959}.

\begin{figure}[bth]
  \center
  \includegraphics[width=12cm]{gfx/communication_theory}
  \caption[A theory of communication]{A theory of communication developed by \defcitealias{shannon:1959}{Claude Shannon}\citetalias{shannon:1959}.}
