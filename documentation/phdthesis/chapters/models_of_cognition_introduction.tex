...
\begin{figure}[bth]
  \center
  \includegraphics[height=4cm]{gfx/state_action}
  \caption[The state-action model]{The state action model.}
  \label{fig:state_action}
\end{figure}

Figure~\ref{fig:state_action} shows the state-action model.
