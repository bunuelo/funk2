...
temporally organize a set of commands.  A plan representation that
demonstrates a branch and a join control structure as represented as a
partially-ordered plan is shown in
