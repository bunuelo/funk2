...
The process of planning requires an inference algorithm that can
imagine states at different points in time.
Figure~\ref{fig:infer_plan_effects} shows inference knowledge for a
plan in an event representation, based on previously induced patterns
