...
\section{Learning to Plan toward Goals}

\begin{figure}[bth]
  \center
  \includegraphics[height=4cm]{gfx/learning_to_plan}
  \caption[Learning to plan toward goals]{Learning to plan is naturally represented in a reflective event representation.}
  \label{fig:learning_to_plan}
\end{figure}

See Figure~\ref{fig:learning_to_plan}.
