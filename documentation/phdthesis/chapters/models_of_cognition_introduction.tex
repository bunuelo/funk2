...
their plans and therefor do not usually focus on having good methods
for credit assignment when plans fail.
...
\begin{figure}[bth]
  \center
  \includegraphics[height=5cm]{gfx/reflective_event_reprensentation}
  \caption[A Reflective Event Representation.}
