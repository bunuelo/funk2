...
\section{Imagining Executing a Partial-Plan}

\begin{figure}[bth]
  \center
  \includegraphics[width=11cm]{gfx/imagine_executing_plan}
  \caption[Imagining executing a plan.]{Imagining executing a plan.}
  \label{fig:imagine_executing_plan}
\end{figure}

See Figure~\ref{fig:imagine_executing_plan}.
