...
sidestepped when one is dealing with reflective knowledge.  Lack of
awareness of these problems could lead to the development of processes
that enter infinite reflection loops, resulting in an infinite memory
consumption pattern.  It is very easy to create reflection loops in a
system with reflective knowledge; while it is not clear that these
type of reflectively ``loopy'' processes are not very useful in some
way, we have found hierarchical reflective knowledge structures to be
a safe way to begin to explore causal relationships in this
represenational problem space.
