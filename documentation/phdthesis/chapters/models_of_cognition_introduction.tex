...
\section{A Plan Representation for Serial and Parallel Plans}

\begin{figure}[bth]
  \center
  \includegraphics[width=10cm]{gfx/serial_and_parallel_plan}
  \caption[A plan with serial and parallel components.]{A plan
    containing serial and parallel components.}
  \label{fig:serial_and_parallel_plan}
\end{figure}

See Figure~\ref{fig:serial_and_parallel_plan}.
