...
\section{Serial Process Representation}
...
representing any Lisp-like expression in our language interpretter.

\section{Representation for Parallel Processes}

\begin{table}
  \myfloatalign
  \begin{tabularx}{\textwidth}{XlllllX}
    & [parog & [prog & [use-left-hand-to-pick-up  & red   & cube]    & \\
    &        &       & [use-left-hand-to-put-on   & blue  & cube]]   & \\
    &        & [prog & [use-right-hand-to-pick-up & green & pyramid] & \\
    &        &       & [use-right-hand-to-put-on  & red   & cube]]]  & \\
  \end{tabularx}
  \caption[Representation of two parallel serial processes.]{Representation of two parallel serial processes.}
...
additional physical action that the agent can choose to perform.
