...
The deliberative layer sees changes as in the physical knowledge base
as well as changes in reactive resource activations as a stream of
events from the reactive layer to the deliberative layer.  While the
