...
reflective layer reconstructs and learns hypotheses for how to
control.
\begin{sidewaysfigure}
  \begin{tabular}{p{8in}}
    % define source coordinates
    \begin{itemize}
    \item Plan for Physical Action in Deliberative Execution Register \tikz[na] \coordinate (executing-plan-label);
    \item Plan for Physical Action in Deliberative Focus Register \tikz[na] \coordinate (focus-plan-label);
  ...
  \hspace{4cm}\parbox{15cm}{\caption[The deliberative planning machine
      knowledge base.]{The deliberative planning machine knowledge
      base.}\label{figure:deliberative_planning_machine_knowledge_base}}
\end{sidewaysfigure}
...
The deliberative planning process can be thought of as a plan
