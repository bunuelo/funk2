...
execute plans in the deliberative planning machine, while also
learning to predict and avoid plan failures in the deliberative
planning machine.  The plan executed in the first planner resulted in
a physical expectation failure.  The plan attempted to assert that a
