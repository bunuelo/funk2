...
The process that controls the individual actions of the deliberative
planning machine can be a plan executing concurrently in the
reflective planning machine.
...
deliberative type knowledge induction by the reflective layer.
\begin{figure}[h]
\centering
...
The reflective layer perceives the deliberative planning machine
knowledge.
{\mbox{\autoref{figure:deliberative_planning_machine_knowledge_base}}}
shows the deliberative planning machine knowledge base.
\begin{figure}[h]
\centering
\includegraphics[width=10cm]{gfx/deliberative_planning_machine_knowledge_base}
\caption[The deliberative planning machine knowledge base.]{The
  deliberative planning machine knowledge base.}
\label{figure:deliberative_planning_machine_knowledge_base}
\end{figure}
