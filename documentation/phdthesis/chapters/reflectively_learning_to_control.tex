...
stack of two blocks.  Specifically, the plan states that if you move
to the left until you are above a block, grab the block, move to the
right until you are above a block, and drop the block you are holding,
the result will be a stack of two blocks.
