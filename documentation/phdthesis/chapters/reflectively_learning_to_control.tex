...
physical reaction.  The deliberative layer first induces common
structures from the semantic knowledge in its reconstruction of the
physical knowledge base.  The deliberative layer stores these
abstractions of types of knowledge are stored in a knowledge base
...
The following are a list of types of abstract knowledge that is
accounted for in the physical type knowledge base:
\begin{itemize}
