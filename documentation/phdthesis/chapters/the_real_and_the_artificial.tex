%************************************************
\chapter{The Real and the Artificial}
\label{chapter:the_real_and_the_artificial}
%************************************************

In this dissertation I focus on a description of thinking that
reflectively learns to accomplish goals.  In
\autoref{part:theory_of_mind}, I will begin with the paradoxical task
of describing reality, that which actually exists.  After describing
something real to think about, I will describe how a model of
reflective thinking necessarily implies an infinite number of layers
of reflection above this initial actual existence.
...
only as an example of the computational description.

I have included a brief discussion of the relationship between
theories of mind and science in \autoref{chapter:science}.
Additionally, I have included a brief discussion of the relationship
between a theory of mind and education in \autoref{chapter:education}.
The theory of mind has important relationships to science and
education, but these are not within the narrow scope of this thesis.
