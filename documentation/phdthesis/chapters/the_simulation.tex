...
mind.  The reflective activity is primarily reflecting on the rest of
...
\begin{equation}
  \mathcal{P} = \{v ~:~ (\text{\tt{reflective-1}}, v) \in S_E \wedge \text{\tt{reflecting-on}} \in \mu[(\text{\tt{reflective-1}}, v)]\}
\end{equation}
