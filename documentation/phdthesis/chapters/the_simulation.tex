...
between causes and effects that are used for planning.  All of these
Spatial arrangements of static symbols compose the models that
thinking activities use to think about planning in the first-order
reflective layer as well as the given activities of the physical
layer.
