...
\item{Gleb Kuznetsov for the first version of the 3D commonsense kitchen layout manager.}
...
\item{Panupong Pasupat for error-correcting graph isomorphism algorithm.}
\item{Mika Braginsky for visualization of mental resources, agencies, and layers.}
\end{itemize}
