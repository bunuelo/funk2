...
\include{chapters/experiment_plotting}
...
\mymargins
\cleardoublepage\include{frontbackmatter/abstract_front}
\mymargins
\include{frontbackmatter/reader_signature_page_01}
\mymargins
\include{frontbackmatter/reader_signature_page_02}
\mymargins
\include{frontbackmatter/reader_signature_page_03}
\mymargins
...
\mymargins
\include{chapters/emotion_machine_cognitive_architecture}
\mymargins
\include{chapters/learning_from_being_told_natural_language_plans}
\mymargins
\include{chapters/learning_asynchronously_from_experience}
\mymargins
\include{chapters/virtual_machine_and_programming_language}

\mymargins
\cleardoublepage\part{Related Work}\label{part:related_work}
\mymargins
\include{chapters/related_models}

\mymargins
\cleardoublepage\part{Evaluation, Future, and Concluding Remarks}\label{part:related_work}
\mymargins
...
%\mymargins
%\cleardoublepage\part{Conclusion}\label{part:related_work}
\mymargins
...
\mymargins
\include{chapters/the_code}


%\mymargins
%\include{chapters/experiment_data}

%\cleardoublepage\part{The Implementation}\label{part:the_implementation}
%\include{chapters/introducing_computation}
%\include{chapters/computational_activities_in_duration}
%\include{chapters/causally_reflective_procedural_tracing}
%\include{chapters/the_mind_monitor_application}
%\include{chapters/related_implementations}

%\cleardoublepage\part{The Simulation}\label{part:the_simulation}
%\include{chapters/introducing_simulation}
%\include{chapters/graph_notation}
%\include{chapters/symbolic_representation}
%\include{chapters/grounded_factual_knowledge}
%\include{chapters/hypotheses_and_counterfactual_knowledge}
%\include{chapters/the_planning_machine}

%\cleardoublepage\part{The Model}\label{part:the_model}
%\include{chapters/modelling_the_continuously_dynamic}
%\include{chapters/learning_causal_hypotheses}
%\include{chapters/layers_of_reflective_thinking}
%\include{chapters/learning_from_success_and_failure}
%\include{chapters/problematic_interpretations}
%\include{chapters/related_models}
%\include{chapters/science}
%\include{chapters/education}
