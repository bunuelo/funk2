...
\hypersetup{%
    ...
    colorlinks=false, linktocpage=false, pdfborder={0 0 0}, pdfstartpage=11, pdfstartview=FitV,% 
...
\mymargins
\cleardoublepage\part{The Substrate}\label{part:the_substrate}
\mymargins
\include{chapters/emotion_machine_cognitive_architecture}
\mymargins
\include{chapters/reflectively_learning_to_control}
\mymargins
\include{chapters/grounded_learning_of_knowledge_utility}
\mymargins
\include{chapters/virtual_operating_system_and_programming_language}
\mymargins
