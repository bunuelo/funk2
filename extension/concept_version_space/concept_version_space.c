...
f2ptr raw__concept_version_space_hypothesis__minimal_generalizations_consistent_with_example(f2ptr cause, f2ptr this, f2ptr example) {
  ...
  f2ptr new_hypotheses = nil;
  {
    ...
    new_hypotheses = raw__cons__new(cause, hypothesis, new_hypotheses);
  }
...
f2ptr raw__concept_version_space_hypothesis__add_removal_callback(f2ptr cause, f2ptr this, f2ptr funk, f2ptr args) {
  ...
  boolean_t already_removed          = boolean__false;
  {
	...
	removal_callbacks = raw__cons__new(cause, callback, removal_callbacks);
...
f2ptr f2__concept_version_space__add_variable_value(f2ptr cause, f2ptr this, f2ptr variable_name, f2ptr variable_value) {
  return raw__concept_version_space__add_variable_value(cause, this, variable_name, variable_value);
}
export_cefunk3(concept_version_space__add_variable_value, this, variable_name, variable_value, 0,
	       "Adds a possible variable value to this concept_version_space.");
  ...
  if (example__positive != nil) {
	...
	while (iter != nil) {
	  f2ptr general_hypothesis = f2__cons__car(cause, iter);
	  {
	    if (raw__concept_version_space_hypothesis__is_consistent_with_example(cause, general_hypothesis, example) != nil) {
	      new_general_hypotheses = raw__cons__new(cause, general_hypothesis, new_general_hypotheses);
	    } else {
	...
	f2ptr new_specific_hypotheses = nil;
	{
	  ...
	  while (iter != nil) {
		...
		new_specific_hypotheses     = raw__cons__new(cause, specific_hypothesis, new_specific_hypotheses);
	      } else {
		removed_specific_hypotheses = raw__cons__new(cause, specific_hypothesis, removed_specific_hypotheses);
	  ...
	  while (iter != nil) {
		...
		while (removed_specific_hypothesis__minimal_generalizations_consistent_with_example__iter != nil) {
		  f2ptr removed_specific_hypothesis__minimal_generalization_consistent_with_example = f2__cons__car(cause, removed_specific_hypothesis__minimal_generalizations_consistent_with_example__iter);
		  {
			...
			new_specific_hypotheses = raw__cons__new(cause, removed_specific_hypothesis__minimal_generalization_consistent_with_example, new_specific_hypotheses);
		      }
		    }
		  }
	...
	f2ptr new_general_hypotheses = nil;
	{
	  ...
	  while (iter != nil) {
		...
		removed_general_hypotheses = raw__cons__new(cause, general_hypothesis, removed_general_hypotheses);
		f2__set__add(cause, all_removed_hypothesis_set, general_hypothesis);
	      }
	    }
	    iter = f2__cons__cdr(cause, iter);
		...
		while (removed_general_hypothesis__minimal_specializations_consistent_with_example__iter != nil) {
		  ...
		  raw__concept_version_space__train_on_example__is_consistent_or_more_general_than_at_least_one_specific_hypothesis__done:
		    if (is_consistent_or_more_general_than_at_least_one_specific_hypothesis) {
		      new_general_hypotheses = raw__cons__new(cause, removed_general_hypothesis__minimal_specialization_consistent_with_example, new_general_hypotheses);
		    } else {
...
f2ptr raw__concept_version_space__supporting_hypotheses(f2ptr cause, f2ptr this, f2ptr example) {
  ...
  if (example__positive == nil) {
	...
	if (assert_value(raw__concept_version_space_hypothesis__is_consistent_with_example(cause, hypothesis, example)) != nil) {
	  supporting_hypotheses = raw__cons__new(cause, hypothesis, supporting_hypotheses);
	}
	iter = f2__cons__cdr(cause, iter);
      }
    }
...
f2ptr raw__concept_version_space__opposing_hypotheses(f2ptr cause, f2ptr this, f2ptr example) {
  ...
  if (example__positive == nil) {
	...
	f2ptr hypothesis = f2__cons__car(cause, iter);
	if (assert_value(raw__concept_version_space_hypothesis__is_consistent_with_example(cause, hypothesis, example)) == nil) {
	  opposing_hypotheses = raw__cons__new(cause, hypothesis, opposing_hypotheses);
	}
	iter = f2__cons__cdr(cause, iter);
      }
    }
  ...
  return opposing_hypotheses;
}

f2ptr f2__concept_version_space__opposing_hypotheses(f2ptr cause, f2ptr this, f2ptr example) {
  assert_argument_type(concept_version_space,         this);
  assert_argument_type(concept_version_space_example, example);
  return raw__concept_version_space__opposing_hypotheses(cause, this, example);
}
export_cefunk2(concept_version_space__opposing_hypotheses, this, example, 0,
	       "Returns all hypotheses in this hypothesis space that oppose the given example.");
...
f2ptr f2__concept_version_space_type__new_aux(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "opposing_hypotheses"),   f2__core_extension_funk__new(cause, new__symbol(cause, "concept_version_space"), new__symbol(cause, "concept_version_space__opposing_hypotheses")));}
  return this;
}
