		...
		while (edge_label_iter != nil) {
		  f2ptr edge_label_pair_string = f2__cons__car(cause, edge_label_iter);
		  {
			...
			printf("\nconceptnet-new_from_graph_file warning: edge_label_pair_iter != nil."); fflush(stdout);
		      ...
		      f2ptr edge_key_string_without_quotes   = f2__string__replace_all(cause, f2__string__remove_all(cause, edge_key_string, new__string(cause, "u\'"), new__string(cause, "")),
										       new__string(cause, "\'"), new__string(cause, ""));
		      f2ptr edge_value_string_without_quotes = f2__string__replace_all(cause, f2__string__remove_all(cause, edge_value_string, new__string(cause, "u\'"), new__string(cause, "")),
										       new__string(cause, "\'"), new__string(cause, ""));
