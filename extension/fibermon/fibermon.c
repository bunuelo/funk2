...
f2ptr f2__fibermon_fiber__redraw_fast(f2ptr cause, f2ptr this) {
  ...
  
  {
    ...
    f2__gtk__label__set_text(cause, raw__array__elt(cause, raw__array__elt(cause, this__table_labels,  6), 1), f2__exp__as__string(cause, (f2__fiber__last_executed_time(cause, this__fiber) != nil) ? f2bool__new(boolean__true) : nil));
