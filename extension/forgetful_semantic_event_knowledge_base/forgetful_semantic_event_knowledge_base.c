...
f2ptr raw__forgetful_semantic_event_knowledge_base__know_of_remove__before_callback(f2ptr cause, f2ptr this, f2ptr semantic_frame, f2ptr key_type, f2ptr key, f2ptr value) {
  if (raw__semantic_event__is_type(cause, semantic_frame)) {
    ...
    if (raw__eq(cause, new__symbol(cause, "property"), key_type) && (raw__eq(cause, new__symbol(cause, "absolute_start_time"), key) ||
      ...
      f2ptr semantic_event_tree = raw__forgetful_semantic_event_knowledge_base__semantic_event_tree(cause, this);
...
f2ptr f2__forgetful_semantic_event_knowledge_base__know_of_remove__before_callback(f2ptr cause, f2ptr this, f2ptr semantic_frame, f2ptr key_type, f2ptr key, f2ptr value) {
  assert_argument_type(forgetful_semantic_event_knowledge_base, this);
  assert_argument_type(semantic_frame,                semantic_frame);
  return raw__forgetful_semantic_event_knowledge_base__know_of_remove__before_callback(cause, this, semantic_frame, key_type, key, value);
}
export_cefunk5(forgetful_semantic_event_knowledge_base__know_of_remove__before_callback, this, semantic_frame, key_type, key, value, 0, "Callback for forgetful_semantic_event_knowledge_base to update internal semantic_event_tree.");


f2ptr raw__forgetful_semantic_event_knowledge_base__know_of_add__after_callback(f2ptr cause, f2ptr this, f2ptr semantic_frame, f2ptr key_type, f2ptr key, f2ptr value) {
  if (raw__semantic_event__is_type(cause, semantic_frame)) {
    f2ptr semantic_event = semantic_frame;
    if (raw__eq(cause, new__symbol(cause, "property"), key_type) && (raw__eq(cause, new__symbol(cause, "absolute_start_time"), key) ||
								     raw__eq(cause, new__symbol(cause, "absolute_end_time"),   key))) {
...
f2ptr f2__forgetful_semantic_event_knowledge_base__know_of_add__after_callback(f2ptr cause, f2ptr this, f2ptr semantic_frame, f2ptr key_type, f2ptr key, f2ptr value) {
  assert_argument_type(forgetful_semantic_event_knowledge_base, this);
  assert_argument_type(semantic_frame,                semantic_frame);
  return raw__forgetful_semantic_event_knowledge_base__know_of_add__after_callback(cause, this, semantic_frame, key_type, key, value);
}
export_cefunk5(forgetful_semantic_event_knowledge_base__know_of_add__after_callback, this, semantic_frame, key_type, key, value, 0, "Callback for forgetful_semantic_event_knowledge_base to update internal semantic_event_tree.");
...
f2ptr raw__forgetful_semantic_event_knowledge_base__type_create(f2ptr cause, f2ptr this, f2ptr name, f2ptr semantic_realm) {
  ...
  assert_value(raw__semantic_knowledge_base__add_trace_callback_funk__remove_semantic_frame_value__before(cause, this, f2__core_extension_funk__new(cause, new__symbol(cause, "forgetful_semantic_event_knowledge_base"), new__symbol(cause, "forgetful_semantic_event_knowledge_base__know_of_remove__before_callback"))));
  assert_value(raw__semantic_knowledge_base__add_trace_callback_funk__add_semantic_frame_value__after(    cause, this, f2__core_extension_funk__new(cause, new__symbol(cause, "forgetful_semantic_event_knowledge_base"), new__symbol(cause, "forgetful_semantic_event_knowledge_base__know_of_add__after_callback"))));
  return this;
}
...
f2ptr f2__forgetful_semantic_event_knowledge_base__semantic_event_tree(f2ptr cause, f2ptr this) {
  assert_argument_type(forgetful_semantic_event_knowledge_base, this);
  return raw__forgetful_semantic_event_knowledge_base__semantic_event_tree(cause, this);
}
export_cefunk1(forgetful_semantic_event_knowledge_base__semantic_event_tree, thing, 0, "Returns this forgetful_semantic_event_knowledge_base's semantic_event_tree.");
...
f2ptr f2__forgetful_semantic_event_knowledge_base__events_containing_time(f2ptr cause, f2ptr this, f2ptr semantic_time) {
  ...
  return raw__forgetful_semantic_event_knowledge_base__events_containing_time(cause, this, semantic_time);
}
export_cefunk2(forgetful_semantic_event_knowledge_base__events_containing_time, this, semantic_time, 0,
	       "Returns the semantic_events from this forgetful_semantic_event_knowledge_base that contain the given time.");
...
f2ptr f2__forgetful_semantic_event_knowledge_base__most_recent_filtered_events(f2ptr cause, f2ptr this, f2ptr filter_funk, f2ptr user_filter_data, f2ptr semantic_time) {
  ...
  assert_argument_type(semantic_time,                 semantic_time);
  return raw__forgetful_semantic_event_knowledge_base__most_recent_filtered_events(cause, this, filter_funk, user_filter_data, semantic_time);
}
export_cefunk4(forgetful_semantic_event_knowledge_base__most_recent_filtered_events, this, filter_funk, user_filter_data, semantic_time, 0,
...
f2ptr raw__forgetful_semantic_event_knowledge_base__event_transframe(f2ptr cause, f2ptr this, f2ptr start_semantic_time, f2ptr end_semantic_time) {
  ...
  {
    f2ptr start_events    = assert_value(raw__forgetful_semantic_event_knowledge_base__events_containing_time(cause, this, start_semantic_time));
    ...
    f2ptr end_events    = assert_value(raw__forgetful_semantic_event_knowledge_base__events_containing_time(cause, this, end_semantic_time));
...
f2ptr f2__forgetful_semantic_event_knowledge_base__event_transframe(f2ptr cause, f2ptr this, f2ptr start_semantic_time, f2ptr end_semantic_time) {
  assert_argument_type(forgetful_semantic_event_knowledge_base, this);
  assert_argument_type(semantic_time,                 start_semantic_time);
  assert_argument_type(semantic_time,                 end_semantic_time);
  return raw__forgetful_semantic_event_knowledge_base__event_transframe(cause, this, start_semantic_time, end_semantic_time);
}
export_cefunk3(forgetful_semantic_event_knowledge_base__event_transframe, this, start_semantic_time, end_semantic_time, 0,
	       "Returns a new semantic_event_transframe derived from this forgetful_semantic_event_knowledge_base that represents the change in events between start_semantic_time and end_semantic_time.");

f2ptr raw__forgetful_semantic_event_knowledge_base__events(f2ptr cause, f2ptr this) {
  f2ptr semantic_event_tree = raw__forgetful_semantic_event_knowledge_base__semantic_event_tree(cause, this);
  return raw__semantic_event_tree__events(cause, semantic_event_tree);
}

f2ptr f2__forgetful_semantic_event_knowledge_base__events(f2ptr cause, f2ptr this) {
  assert_argument_type(forgetful_semantic_event_knowledge_base, this);
  return raw__forgetful_semantic_event_knowledge_base__events(cause, this);
}
export_cefunk1(forgetful_semantic_event_knowledge_base__events, this, 0,
	       "Returns all events within this forgetful_semantic_event_knowledge_base.");
...
f2ptr f2__forgetful_semantic_event_knowledge_base_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "semantic_event_tree"),         f2__core_extension_funk__new(cause, new__symbol(cause, "forgetful_semantic_event_knowledge_base"), new__symbol(cause, "forgetful_semantic_event_knowledge_base__semantic_event_tree")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "events_containing_time"),      f2__core_extension_funk__new(cause, new__symbol(cause, "forgetful_semantic_event_knowledge_base"), new__symbol(cause, "forgetful_semantic_event_knowledge_base__events_containing_time")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "most_recent_filtered_events"), f2__core_extension_funk__new(cause, new__symbol(cause, "forgetful_semantic_event_knowledge_base"), new__symbol(cause, "forgetful_semantic_event_knowledge_base__most_recent_filtered_events")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "event_transframe"),            f2__core_extension_funk__new(cause, new__symbol(cause, "forgetful_semantic_event_knowledge_base"), new__symbol(cause, "forgetful_semantic_event_knowledge_base__event_transframe")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "events"),                      f2__core_extension_funk__new(cause, new__symbol(cause, "forgetful_semantic_event_knowledge_base"), new__symbol(cause, "forgetful_semantic_event_knowledge_base__events")));}
  return this;
}
...
f2ptr f2__forgetful_semantic_event_knowledge_base__core_extension__initialize(f2ptr cause) {
  core_extension__ping(forgetful_semantic_event_knowledge_base, meta_semantic_knowledge_base);
  core_extension__ping(forgetful_semantic_event_knowledge_base, semantic_event);
  core_extension__ping(forgetful_semantic_event_knowledge_base, semantic_event_tree);
  core_extension__ping(forgetful_semantic_event_knowledge_base, semantic_event_transframe);
