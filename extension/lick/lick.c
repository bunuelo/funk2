...
f2ptr raw__ptypehash__lick_chunk__unlick_with_notes(f2ptr cause, f2ptr lick_chunk, f2ptr object_note_hash) {
  ...
  f2ptr ptypehash = f2ptypehash__new(cause, f2__cmutex__new(cause), f2__cmutex__new(cause), f2integer__new(cause, 0), key_count__lick_note, bin_num_power__lick_note, bin_array__lick_note);
  return ptypehash;
}
