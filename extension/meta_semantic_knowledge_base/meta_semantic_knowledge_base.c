...
f2ptr raw__relationship_meta_semantic_frame__terminal_print_with_frame(f2ptr cause, f2ptr this, f2ptr terminal_print_frame) {
  f2ptr print_as_frame_hash = raw__terminal_print_frame__print_as_frame_hash(cause, terminal_print_frame);
  f2ptr frame               = raw__ptypehash__lookup(cause, print_as_frame_hash, this);
  if (frame == nil) {
    frame = f2__frame__new(cause, f2list10__new(cause,
						new__symbol(cause, "print_object_type"), new__symbol(cause, "relationship_meta_semantic_frame"),
						new__symbol(cause, "source"),            raw__relationship_meta_semantic_frame__source(cause, this),
						new__symbol(cause, "key_type"),          raw__relationship_meta_semantic_frame__key_type(cause, this),
						new__symbol(cause, "key"),               raw__relationship_meta_semantic_frame__key(cause, this),
						new__symbol(cause, "target"),            raw__relationship_meta_semantic_frame__target(cause, this)));
    f2__ptypehash__add(cause, print_as_frame_hash, this, frame);
  }
  return raw__frame__terminal_print_with_frame(cause, frame, terminal_print_frame);
}

f2ptr f2__relationship_meta_semantic_frame__terminal_print_with_frame(f2ptr cause, f2ptr this, f2ptr terminal_print_frame) {
  if (! raw__relationship_meta_semantic_frame__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__relationship_meta_semantic_frame__terminal_print_with_frame(cause, this, terminal_print_frame);
}
export_cefunk2(relationship_meta_semantic_frame__terminal_print_with_frame, this, terminal_print_frame, 0, "");
...
f2ptr f2__relationship_meta_semantic_frame_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.execute__symbol, new__symbol(cause, "terminal_print_with_frame"), f2__core_extension_funk__new(cause, new__symbol(cause, "meta_semantic_knowledge_base"), new__symbol(cause, "relationship_meta_semantic_frame__terminal_print_with_frame")));}
  return this;
}
