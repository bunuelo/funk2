...
f2ptr f2__semantic_action_event__new(f2ptr cause, f2ptr semantic_realm, f2ptr action_name, f2ptr agent) {
  ...
  return raw__semantic_action_event__new(cause, semantic_realm, action_name, agent);
}
export_cefunk3(semantic_action_event__new, semantic_realm, action_name, agent, 0, "Returns a new semantic_action_event object.");
...
f2ptr raw__semantic_action_event__agent(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "agent"));
}
...
f2ptr f2__semantic_action_event__agent(f2ptr cause, f2ptr this) {
  ...
  return raw__semantic_action_event__agent(cause, this);
}
export_cefunk1(semantic_action_event__agent, this, 0, "");


f2ptr raw__semantic_action_event__agent__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "agent"), that);
}

f2ptr f2__semantic_action_event__agent__set(f2ptr cause, f2ptr this, f2ptr that) {
  if ((! raw__semantic_action_event__is_type(cause, this)) ||
      ((that != nil) && (! raw__semantic_frame__is_type(cause, that)))) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_action_event__agent__set(cause, this, that);
}
export_cefunk2(semantic_action_event__agent__set, this, that, 0, "");
...
f2ptr f2__semantic_action_event_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "execute"), new__symbol(cause, "new"),     f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_action_event"), new__symbol(cause, "semantic_action_event__new")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "execute"), new__symbol(cause, "is_type"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_action_event"), new__symbol(cause, "semantic_action_event__is_type")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "type"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_action_event"), new__symbol(cause, "semantic_action_event__type")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "agent"),   f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_action_event"), new__symbol(cause, "semantic_action_event__agent")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),     new__symbol(cause, "agent"),   f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_action_event"), new__symbol(cause, "semantic_action_event__agent__set")));}
  return this;
}
...
export_cefunk0(semantic_action_event__core_extension__initialize, 0, "");

f2ptr f2__semantic_action_event__core_extension__destroy(f2ptr cause) {
  status("semantic_action_event destroyed.");
  return nil;
}
export_cefunk0(semantic_action_event__core_extension__destroy, 0, "");
