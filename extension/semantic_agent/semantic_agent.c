...
f2ptr f2__semantic_agent__core_extension_ping(f2ptr cause) {
  return nil;
}
export_cefunk0(semantic_agent__core_extension_ping, 0, "");

f2ptr f2__semantic_agent__core_extension_initialize(f2ptr cause) {
  {
    f2ptr result = f2__force_funk_apply(cause, f2__this__fiber(cause), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_physical_object"), new__symbol(cause, "semantic_physical_object__core_extension_ping")), nil);
...
export_cefunk0(semantic_agent__core_extension_initialize, 0, "");

f2ptr f2__semantic_agent__core_extension_destroy(f2ptr cause) {
  status("semantic_agent destroyed.");
  return nil;
}
export_cefunk0(semantic_agent__core_extension_destroy, 0, "");
