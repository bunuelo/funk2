...
f2ptr raw__semantic_containment_object__new(f2ptr cause, f2ptr semantic_realm) {
  ...
  raw__semantic_frame__add( cause, this, new__symbol(cause, "type"), new__symbol(cause, "name"), new__symbol(cause, "semantic_containment_object"));
  return this;
}
...
export_cefunk0(semantic_containment_object__core_extension_ping, 0, "");
...
export_cefunk0(semantic_containment_object__core_extension_initialize, 0, "");

f2ptr f2__semantic_containment_object__core_extension_destroy(f2ptr cause) {
  status("semantic_containment_object destroyed.");
  return nil;
}
export_cefunk0(semantic_containment_object__core_extension_destroy, 0, "");
