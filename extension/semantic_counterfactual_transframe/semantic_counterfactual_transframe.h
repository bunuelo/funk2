...
#ifndef F2__EXTENSION__SEMANTIC_COUNTERFACTUAL_TRANSFRAME__H
#define F2__EXTENSION__SEMANTIC_COUNTERFACTUAL_TRANSFRAME__H
...
#endif // F2__EXTENSION__SEMANTIC_COUNTERFACTUAL_TRANSFRAME__H
