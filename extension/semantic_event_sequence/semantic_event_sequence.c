...
f2ptr raw__semantic_event_sequence__update_parent_container_start_and_end_times_with_child_start_time(f2ptr cause, f2ptr this, f2ptr child_start_time) {
...
f2ptr raw__semantic_event_sequence__update_parent_container_start_and_end_times_with_child_end_time(f2ptr cause, f2ptr this, f2ptr child_end_time) {
  f2ptr absolute_start_time = f2__object__semantic__get(cause, this, new__symbol(cause, "absolute_start_time"), nil);
  if (raw__larva__is_type(cause, absolute_start_time)) {
    return absolute_start_time;
  }
...
f2ptr raw__semantic_event_sequence__update_parent_container_start_and_end_times_with_child_event(f2ptr cause, f2ptr this, f2ptr child_semantic_event) {
  {
    ...
    {
      f2ptr result = raw__semantic_event_sequence__update_parent_container_start_and_end_times_with_child_start_time(cause, this, child_semantic_event__absolute_start_time);
      if (raw__larva__is_type(cause, result)) {
	return result;
      }
    }
  }
  {
    ...
    {
      f2ptr result = raw__semantic_event_sequence__update_parent_container_start_and_end_times_with_child_end_time(cause, this, child_semantic_event__absolute_end_time);
      if (raw__larva__is_type(cause, result)) {
	return result;
      }
    }
...
f2ptr f2__semantic_event_sequence__update_parent_container_start_and_end_times_with_child_event(f2ptr cause, f2ptr this, f2ptr child_semantic_event) {
  assert_argument_type(semantic_event_sequence, this);
  assert_argument_type(semantic_event,          child_semantic_event);
  return raw__semantic_event_sequence__update_parent_container_start_and_end_times_with_child_event(cause, this, child_semantic_event);
}
export_cefunk2(semantic_event_sequence__update_parent_container_start_and_end_times_with_child_event, this, child_semantic_event, 0, "");


f2ptr raw__semantic_event_sequence__update_child_container_start_and_end_times_with_parent_start_time(f2ptr cause, f2ptr this, f2ptr parent_start_time) {
  f2ptr absolute_start_time = f2__object__semantic__get(cause, this, new__symbol(cause, "absolute_start_time"), nil);
  if (raw__larva__is_type(cause, absolute_start_time)) {
    return absolute_start_time;
  }
...
f2ptr raw__semantic_event_sequence__update_child_container_start_and_end_times_with_parent_end_time(f2ptr cause, f2ptr this, f2ptr parent_end_time) {
  f2ptr absolute_start_time = f2__object__semantic__get(cause, this, new__symbol(cause, "absolute_start_time"), nil);
  if (raw__larva__is_type(cause, absolute_start_time)) {
    return absolute_start_time;
  }
...
f2ptr raw__semantic_event_sequence__update_child_container_start_and_end_times_with_parent_event(f2ptr cause, f2ptr this, f2ptr parent_semantic_event) {
  {
    ...
    {
      f2ptr result = raw__semantic_event_sequence__update_child_container_start_and_end_times_with_parent_start_time(cause, this, parent_semantic_event__absolute_start_time);
      if (raw__larva__is_type(cause, result)) {
	return result;
      }
    }
  }
  {
    ...
    {
      f2ptr result = raw__semantic_event_sequence__update_child_container_start_and_end_times_with_parent_end_time(cause, this, parent_semantic_event__absolute_end_time);
      if (raw__larva__is_type(cause, result)) {
	return result;
      }
    }
...
f2ptr f2__semantic_event_sequence__update_child_container_start_and_end_times_with_parent_event(f2ptr cause, f2ptr this, f2ptr parent_semantic_event) {
  assert_argument_type(semantic_event_sequence, this);
  assert_argument_type(semantic_event,          parent_semantic_event);
  return raw__semantic_event_sequence__update_child_container_start_and_end_times_with_parent_event(cause, this, parent_semantic_event);
}
export_cefunk2(semantic_event_sequence__update_child_container_start_and_end_times_with_parent_event, this, parent_semantic_event, 0, "");
...
f2ptr f2__semantic_event_sequence_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "execute"),         new__symbol(cause, "update_parent_container_start_and_end_times_with_parent_event"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_event_sequence"), new__symbol(cause, "semantic_event_sequence__update_parent_container_start_and_end_times_with_parent_event")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "execute"),         new__symbol(cause, "update_child_container_start_and_end_times_with_parent_event"),  f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_event_sequence"), new__symbol(cause, "semantic_event_sequence__update_child_container_start_and_end_times_with_parent_event")));}
