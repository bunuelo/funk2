...
f2ptr f2__semantic_event_sequence_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "execute"),         new__symbol(cause, "update_parent_container_start_and_end_times_with_child_event"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_event_sequence"), new__symbol(cause, "semantic_event_sequence__update_parent_container_start_and_end_times_with_child_event")));}
