...
f2ptr raw__semantic_event_transframe__removal__lookup_set(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_set(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "removal"));
}

f2ptr f2__semantic_event_transframe__removal__lookup_set(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_event_transframe, this);
  return raw__semantic_event_transframe__removal__lookup_set(cause, this);
}
export_cefunk1(semantic_event_transframe__removal__lookup_set, this, 0, "");
...
f2ptr raw__semantic_event_transframe__addition__lookup_set(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_set(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "addition"));
}

f2ptr f2__semantic_event_transframe__addition__lookup_set(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_event_transframe, this);
  return raw__semantic_event_transframe__addition__lookup_set(cause, this);
}
export_cefunk1(semantic_event_transframe__addition__lookup_set, this, 0, "");
...
f2ptr f2__semantic_event_transframe__primobject_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "removal"),  f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_event_transframe"), new__symbol(cause, "semantic_event_transframe__removal__lookup_set")));}
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "addition"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_event_transframe"), new__symbol(cause, "semantic_event_transframe__addition__lookup_set")));}
