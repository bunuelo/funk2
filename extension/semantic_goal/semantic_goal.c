...
f2ptr f2__semantic_goal__is_occurring(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_goal, this);
  return raw__semantic_goal__is_occurring(cause, this);
}
export_cefunk1(semantic_goal__is_occurring, this, 0, "");
...
f2ptr f2__semantic_goal__is_occurring__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_goal, this);
  return raw__semantic_goal__is_occurring__set(cause, this, that);
}
export_cefunk2(semantic_goal__is_occurring__set, this, that, 0, "");
...
f2ptr f2__semantic_goal_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),     new__symbol(cause, "is_occurring"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_goal"), new__symbol(cause, "semantic_goal__is_occurring")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),     new__symbol(cause, "is_occurring"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_goal"), new__symbol(cause, "semantic_goal__is_occurring__set")));}
  return this;
}
...
f2ptr f2__semantic_goal__core_extension__initialize(f2ptr cause) {
  core_extension__ping(semantic_goal, semantic_object);
...
f2ptr f2__semantic_goal__core_extension__define_types(f2ptr cause) {
  f2__add_type(cause, new__symbol(cause, "semantic_goal"), f2__semantic_goal_type__new(cause));
