...
f2ptr raw__semantic_goal__is_occurring__lookup_set(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_set(cause, this, new__symbol(cause, "property"), new__symbol(cause, "is_occurring"));
}

f2ptr f2__semantic_goal__is_occurring__lookup_set(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_goal, this);
  return raw__semantic_goal__is_occurring__lookup_set(cause, this);
}
export_cefunk1(semantic_goal__is_occurring__lookup_set, this, 0, "");
...
f2ptr f2__semantic_goal_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "is_occurring"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_goal"), new__symbol(cause, "semantic_goal__is_occurring__lookup_set")));}
