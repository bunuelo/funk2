...
f2ptr raw__semantic_know_of_existence_event__phenomenal_name__lookup(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup(cause, this, new__symbol(cause, "property"), new__symbol(cause, "phenomenal_name"));
}

f2ptr f2__semantic_know_of_existence_event__phenomenal_name__lookup(f2ptr cause, f2ptr this) {
  if (! raw__semantic_know_of_existence_event__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_know_of_existence_event__phenomenal_name__lookup(cause, this);
}
export_cefunk1(semantic_know_of_existence_event__phenomenal_name__lookup, this, 0, "");
...
f2ptr raw__semantic_know_of_existence_event__cairo_render_frame(f2ptr cause, f2ptr this) {
  ...
  f2ptr phenomenal_name_set = f2__semantic_know_of_existence_event__phenomenal_name__lookup(cause, this);
...
f2ptr f2__semantic_know_of_existence_event_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup"), new__symbol(cause, "phenomenal_name"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_know_of_existence_event"), new__symbol(cause, "semantic_know_of_existence_event__phenomenal_name__lookup")));}
