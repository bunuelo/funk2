...
f2ptr raw__semantic_frame__terminal_print_with_frame(f2ptr cause, f2ptr this, f2ptr terminal_print_frame) {
  ...
  if (frame == nil) {
    frame = f2__frame__new(cause, f2list8__new(cause,
					       ...
					       new__symbol(cause, "time"),              raw__semantic_frame__time(cause, this),
					       new__symbol(cause, "event_type"),        raw__semantic_frame__event_type(cause, this),
					       new__symbol(cause, "semantic_frame"),    raw__semantic_frame__semantic_frame(cause, this)));
    f2__ptypehash__add(cause, print_as_frame_hash, this, frame);
  }
  return raw__frame__terminal_print_with_frame(cause, frame, terminal_print_frame);
}
