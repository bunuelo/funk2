...
f2ptr f2__semantic_knowledge_base_type__new_aux(f2ptr cause) {
  ...
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "get",     "as-graph",                                                   as__graph);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_semantic_frame",                                         add_semantic_frame);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "remove_semantic_frame",                                      remove_semantic_frame);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "get",     "contains_semantic_frame",                                    contains_semantic_frame);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "remove_all",                                                 remove_all);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_semantic_knowledge_base",                                add_semantic_knowledge_base);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_trace_callback_funk",                                    add_trace_callback_funk);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_trace_callback_funk-add_semantic_frame_value-before",    add_trace_callback_funk-add_semantic_frame_value-before);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_trace_callback_funk-add_semantic_frame_value-after",     add_trace_callback_funk-add_semantic_frame_value-after);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_trace_callback_funk-remove_semantic_frame_value-before", add_trace_callback_funk-remove_semantic_frame_value-before);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_trace_callback_funk-remove_semantic_frame_value-after",  add_trace_callback_funk-remove_semantic_frame_value-after);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_trace_event",                                            add_trace_event);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "know_before_semantic_frame_value_addition",                  know_before_semantic_frame_value_addition);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "know_after_semantic_frame_value_addition",                   know_after_semantic_frame_value_addition);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "know_before_semantic_frame_value_removal",                   know_before_semantic_frame_value_removal);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "know_after_semantic_frame_value_removal",                    know_after_semantic_frame_value_removal);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "recursively_add_semantic_frames_to_set",                     recursively_add_semantic_frames_to_set);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "add_to_graph_with_node_ptypehash",                           add_to_graph_with_node_ptypehash);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "get",     "as-digraph_dot_code",                                        as__digraph_dot_code);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "get",     "new-event_stream_iterator",                                  new__event_stream_iterator);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "get",     "semantic_frames",                                            semantic_frames);
  core_extension_primobject_type__add_funk(semantic_causal_event,   semantic_knowledge_base, "get",     "as-timeline",                                                as__timeline);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "copy_differences_to",                                        copy_differences_to);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "gather_lick_notes",                                          gather_lick_notes);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "lick_to_chunk",                                              lick_to_chunk);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "lick_chunk-unlick_with_notes",                               lick_chunk__unlick_with_notes);
  core_extension_primobject_type__add_funk(semantic_knowledge_base, semantic_knowledge_base, "execute", "lick_chunk-unlick_replace_notes_with_objects",               lick_chunk__unlick_replace_notes_with_objects);
  return this;
}
