...
f2ptr raw__semantic_object_type__example__lookup_set(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_set(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "example"));
}

f2ptr f2__semantic_object_type__example__lookup_set(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_object_type, this);
  return raw__semantic_object_type__example__lookup_set(cause, this);
}
export_cefunk1(semantic_object_type__example__lookup_set, this, 0, "");
...
f2ptr f2__semantic_object_type_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "example"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_object_type"), new__symbol(cause, "semantic_object_type__example__lookup_set")));}
