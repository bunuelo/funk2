...
#include "semantic_object_type_event.h"
...
boolean_t raw__semantic_object_type_event__is_type(f2ptr cause, f2ptr thing) {
  ...
  f2ptr this_type_name_symbol = new__symbol(cause, "semantic_object_type_event");
...
f2ptr f2__semantic_object_type_event__is_type(f2ptr cause, f2ptr thing) {
  return f2bool__new(raw__semantic_object_type_event__is_type(cause, thing));
}
export_cefunk1(semantic_object_type_event__is_type, thing, 0, "Returns whether or not thing is of type semantic_object_type_event.");
...
f2ptr f2__semantic_object_type_event__type(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_object_type_event, this);
  return raw__semantic_object_type_event__type(cause, this);
}
export_cefunk1(semantic_object_type_event__type, thing, 0, "Returns the specific type of object that this semantic_object_type_event is.");


f2ptr raw__semantic_object_type_event__example__lookup_set(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_set(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "example"));
}

f2ptr f2__semantic_object_type_event__example__lookup_set(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_object_type_event, this);
  return raw__semantic_object_type_event__example__lookup_set(cause, this);
}
export_cefunk1(semantic_object_type_event__example__lookup_set, this, 0, "");
...
f2ptr f2__semantic_object_type_event__example__add(f2ptr cause, f2ptr this, f2ptr that) {
  ...
  return raw__semantic_object_type_event__example__add(cause, this, that);
}
export_cefunk2(semantic_object_type_event__example__add, this, that, 0, "");
...
f2ptr f2__semantic_object_type_event__example__remove(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_object_type_event, this);
  //assert_argument_type(semantic_object,      that);
  return raw__semantic_object_type_event__example__remove(cause, this, that);
}
export_cefunk2(semantic_object_type_event__example__remove, this, that, 0, "");
...
f2ptr f2__semantic_object_type_event_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "example"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_object_type_event"), new__symbol(cause, "semantic_object_type_event__example__lookup_set")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-add"),        new__symbol(cause, "example"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_object_type_event"), new__symbol(cause, "semantic_object_type_event__example__add")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-remove"),     new__symbol(cause, "example"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_object_type_event"), new__symbol(cause, "semantic_object_type_event__example__remove")));}
  return this;
}
...
f2ptr f2__semantic_object_type_event__core_extension__initialize(f2ptr cause) {
  core_extension__ping(semantic_object_type_event, semantic_object);
  status("semantic_object_type_event initialized.");
  return nil;
}
export_cefunk0(semantic_object_type_event__core_extension__initialize, 0, "");

f2ptr f2__semantic_object_type_event__core_extension__define_types(f2ptr cause) {
  f2__add_type(cause, new__symbol(cause, "semantic_object_type_event"), f2__semantic_object_type_event_type__new(cause));
  status("semantic_object_type_event define types.");
  return nil;
}
export_cefunk0(semantic_object_type_event__core_extension__define_types, 0, "");

f2ptr f2__semantic_object_type_event__core_extension__destroy(f2ptr cause) {
  status("semantic_object_type_event destroyed.");
  return nil;
}
export_cefunk0(semantic_object_type_event__core_extension__destroy, 0, "");
