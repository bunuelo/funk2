...
f2ptr raw__semantic_physical_object__physical_object_type(f2ptr cause, f2ptr this) {
...
f2ptr raw__semantic_physical_object__physical_object_type__set(f2ptr cause, f2ptr this, f2ptr that) {
