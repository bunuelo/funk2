...
f2ptr raw__semantic_physical_object__type_create(f2ptr cause, f2ptr this, f2ptr semantic_realm) {
...
f2ptr raw__semantic_physical_object__object_type__lookup(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup(cause, this, new__symbol(cause, "property"), new__symbol(cause, "object_type"));
}

f2ptr f2__semantic_physical_object__object_type__lookup(f2ptr cause, f2ptr this) {
  if (! raw__semantic_physical_object__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_physical_object__object_type__lookup(cause, this);
}
export_cefunk1(semantic_physical_object__object_type__lookup, this, 0, "");
...
f2ptr f2__semantic_physical_object_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup"), new__symbol(cause, "object_type"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_physical_object"), new__symbol(cause, "semantic_physical_object__object_type__lookup")));}
...
export_cefunk0(semantic_physical_object__core_extension__destroy, 0, "");
