...
f2ptr     raw__semantic_physical_object_type_event__example__lookup_set(f2ptr cause, f2ptr this);
f2ptr      f2__semantic_physical_object_type_event__example__lookup_set(f2ptr cause, f2ptr this);
f2ptr     raw__semantic_physical_object_type_event__example__add       (f2ptr cause, f2ptr this, f2ptr that);
f2ptr      f2__semantic_physical_object_type_event__example__add       (f2ptr cause, f2ptr this, f2ptr that);
f2ptr     raw__semantic_physical_object_type_event__example__remove    (f2ptr cause, f2ptr this, f2ptr that);
f2ptr      f2__semantic_physical_object_type_event__example__remove    (f2ptr cause, f2ptr this, f2ptr that);
...
#endif // F2__EXTENSION__SEMANTIC_PHYSICAL_OBJECT_TYPE_EVENT__H
