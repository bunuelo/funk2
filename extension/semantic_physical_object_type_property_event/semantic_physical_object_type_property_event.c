...
#include "semantic_physical_object_type_property_event.h"
...
boolean_t raw__semantic_physical_object_type_property_event__is_type(f2ptr cause, f2ptr thing) {
  ...
  f2ptr this_type_name_symbol = new__symbol(cause, "semantic_physical_object_type_property_event");
...
f2ptr f2__semantic_physical_object_type_property_event__is_type(f2ptr cause, f2ptr thing) {
  return f2bool__new(raw__semantic_physical_object_type_property_event__is_type(cause, thing));
}
export_cefunk1(semantic_physical_object_type_property_event__is_type, thing, 0, "Returns whether or not thing is of type semantic_physical_object_type_property_event.");


f2ptr raw__semantic_physical_object_type_property_event__type(f2ptr cause, f2ptr this) {
  return f2__object__type(cause, this);
}

f2ptr f2__semantic_physical_object_type_property_event__type(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_physical_object_type_property_event, this);
  return raw__semantic_physical_object_type_property_event__type(cause, this);
}
...
f2ptr f2__semantic_physical_object_type_property_event__count(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_physical_object_type_property_event, this);
  return raw__semantic_physical_object_type_property_event__count(cause, this);
}
export_cefunk1(semantic_physical_object_type_property_event__count, this, 0, "");


f2ptr raw__semantic_physical_object_type_property_event__count__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "count"), that);
}

f2ptr f2__semantic_physical_object_type_property_event__count__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_physical_object_type_property_event, this);
  assert_argument_type(integer,                                that);
  return raw__semantic_physical_object_type_property_event__count__set(cause, this, that);
}
export_cefunk2(semantic_physical_object_type_property_event__count__set, this, that, 0, "");
...
f2ptr f2__semantic_physical_object_type_property_event__core_extension__ping(f2ptr cause) {
  return nil;
}
export_cefunk0(semantic_physical_object_type_property_event__core_extension__ping, 0, "");
...
export_cefunk0(semantic_physical_object_type_property_event__core_extension__initialize, 0, "");

f2ptr f2__semantic_physical_object_type_property_event__core_extension__define_types(f2ptr cause) {
  f2__add_type(cause, new__symbol(cause, "semantic_physical_object_type_property_event"), f2__semantic_physical_object_type_property_event_type__new(cause));
  status("semantic_physical_object_type_property_event define types.");
  return nil;
}
export_cefunk0(semantic_physical_object_type_property_event__core_extension__define_types, 0, "");

f2ptr f2__semantic_physical_object_type_property_event__core_extension__destroy(f2ptr cause) {
  status("semantic_physical_object_type_property_event destroyed.");
  return nil;
}
export_cefunk0(semantic_physical_object_type_property_event__core_extension__destroy, 0, "");
