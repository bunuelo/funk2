...
f2ptr raw__semantic_plan_object__type_create(f2ptr cause, f2ptr this, f2ptr semantic_realm, f2ptr phenomenal_name, f2ptr nonsemantic_plan) {
  ...
  raw__semantic_frame__add(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "first_hypothesized_to_cause_goal"), nil);
...
f2ptr raw__semantic_plan_object__has_been_imagined(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "has_been_imagined"));
}

f2ptr f2__semantic_plan_object__has_been_imagined(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__has_been_imagined(cause, this);
}
export_cefunk1(semantic_plan_object__has_been_imagined, this, 0, "");


f2ptr raw__semantic_plan_object__has_been_imagined__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "has_been_imagined"), that);
}

f2ptr f2__semantic_plan_object__has_been_imagined__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__has_been_imagined__set(cause, this, that);
}
export_cefunk2(semantic_plan_object__has_been_imagined__set, this, that, 0, "");



f2ptr raw__semantic_plan_object__imagined_complete_failure(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "imagined_complete_failure"));
}

f2ptr f2__semantic_plan_object__imagined_complete_failure(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__imagined_complete_failure(cause, this);
}
export_cefunk1(semantic_plan_object__imagined_complete_failure, this, 0, "");


f2ptr raw__semantic_plan_object__imagined_complete_failure__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "imagined_complete_failure"), that);
}

f2ptr f2__semantic_plan_object__imagined_complete_failure__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__imagined_complete_failure__set(cause, this, that);
}
export_cefunk2(semantic_plan_object__imagined_complete_failure__set, this, that, 0, "");



f2ptr raw__semantic_plan_object__executed_complete_failure(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "executed_complete_failure"));
}

f2ptr f2__semantic_plan_object__executed_complete_failure(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__executed_complete_failure(cause, this);
}
export_cefunk1(semantic_plan_object__executed_complete_failure, this, 0, "");


f2ptr raw__semantic_plan_object__executed_complete_failure__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "executed_complete_failure"), that);
}

f2ptr f2__semantic_plan_object__executed_complete_failure__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__executed_complete_failure__set(cause, this, that);
}
export_cefunk2(semantic_plan_object__executed_complete_failure__set, this, that, 0, "");
...
f2ptr raw__semantic_plan_object__first_hypothesized_to_cause_goal(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "first_hypothesized_to_cause_goal"));
}

f2ptr f2__semantic_plan_object__first_hypothesized_to_cause_goal(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__first_hypothesized_to_cause_goal(cause, this);
}
export_cefunk1(semantic_plan_object__first_hypothesized_to_cause_goal, this, 0, "");


f2ptr raw__semantic_plan_object__first_hypothesized_to_cause_goal__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "first_hypothesized_to_cause_goal"), that);
}

f2ptr f2__semantic_plan_object__first_hypothesized_to_cause_goal__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__first_hypothesized_to_cause_goal__set(cause, this, that);
}
export_cefunk2(semantic_plan_object__first_hypothesized_to_cause_goal__set, this, that, 0, "");



f2ptr raw__semantic_plan_object__previous(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "previous"));
}

f2ptr f2__semantic_plan_object__previous(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__previous(cause, this);
}
export_cefunk1(semantic_plan_object__previous, this, 0, "");


f2ptr raw__semantic_plan_object__previous__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "previous"), that);
}

f2ptr f2__semantic_plan_object__previous__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_plan_object, this);
  return raw__semantic_plan_object__previous__set(cause, this, that);
}
export_cefunk2(semantic_plan_object__previous__set, this, that, 0, "");
...
f2ptr f2__semantic_plan_object__primobject_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),                 new__symbol(cause, "has_been_imagined"),                   f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__has_been_imagined")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),                 new__symbol(cause, "has_been_imagined"),                   f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__has_been_imagined__set")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),                 new__symbol(cause, "imagined_complete_failure"),           f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__imagined_complete_failure")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),                 new__symbol(cause, "imagined_complete_failure"),           f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__imagined_complete_failure__set")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),                 new__symbol(cause, "executed_complete_failure"),           f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__executed_complete_failure")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),                 new__symbol(cause, "executed_complete_failure"),           f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__executed_complete_failure__set")));}
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),                 new__symbol(cause, "first_hypothesized_to_cause_goal"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__first_hypothesized_to_cause_goal")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),                 new__symbol(cause, "first_hypothesized_to_cause_goal"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_plan_object"), new__symbol(cause, "semantic_plan_object__first_hypothesized_to_cause_goal__set")));}
