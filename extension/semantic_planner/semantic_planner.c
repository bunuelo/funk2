...
f2ptr raw__semantic_planner__type_create(f2ptr cause, f2ptr this, f2ptr semantic_realm) {
  ...
  raw__semantic_frame__add(cause, this, new__symbol(cause, "property"), new__symbol(cause, "imagine_time"),    nil);
  ...
  raw__semantic_frame__add(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "environment"),     nil);
  return this;
}
...
f2ptr raw__semantic_planner__imagine_time(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "imagine_time"));
}

f2ptr f2__semantic_planner__imagine_time(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_planner, this);
  return raw__semantic_planner__imagine_time(cause, this);
}
export_cefunk1(semantic_planner__imagine_time, this, 0, "");


f2ptr raw__semantic_planner__imagine_time__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "property"), new__symbol(cause, "imagine_time"), that);
}

f2ptr f2__semantic_planner__imagine_time__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_planner, this);
  return raw__semantic_planner__imagine_time__set(cause, this, that);
}
export_cefunk2(semantic_planner__imagine_time__set, this, that, 0, "");
...
f2ptr raw__semantic_planner__environment(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "environment"));
}

f2ptr f2__semantic_planner__environment(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_planner, this);
  return raw__semantic_planner__environment(cause, this);
}
export_cefunk1(semantic_planner__environment, this, 0, "");


f2ptr raw__semantic_planner__environment__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "environment"), that);
}

f2ptr f2__semantic_planner__environment__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_planner, this);
  return raw__semantic_planner__environment__set(cause, this, that);
}
export_cefunk2(semantic_planner__environment__set, this, that, 0, "");


f2ptr raw__semantic_planner__stack(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "stack"));
}

f2ptr f2__semantic_planner__stack(f2ptr cause, f2ptr this) {
  assert_argument_type(semantic_planner, this);
  return raw__semantic_planner__stack(cause, this);
}
export_cefunk1(semantic_planner__stack, this, 0, "");


f2ptr raw__semantic_planner__stack__set(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__replace_type_var_value(cause, this, new__symbol(cause, "relation"), new__symbol(cause, "stack"), that);
}

f2ptr f2__semantic_planner__stack__set(f2ptr cause, f2ptr this, f2ptr that) {
  assert_argument_type(semantic_planner, this);
  return raw__semantic_planner__stack__set(cause, this, that);
}
export_cefunk2(semantic_planner__stack__set, this, that, 0, "");
...
f2ptr f2__semantic_planner__primobject_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),                 new__symbol(cause, "imagine_time"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_planner"), new__symbol(cause, "semantic_planner__imagine_time")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),                 new__symbol(cause, "imagine_time"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_planner"), new__symbol(cause, "semantic_planner__imagine_time__set")));}
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),                 new__symbol(cause, "environment"),     f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_planner"), new__symbol(cause, "semantic_planner__environment")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),                 new__symbol(cause, "environment"),     f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_planner"), new__symbol(cause, "semantic_planner__environment__set")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "get"),                 new__symbol(cause, "stack"),           f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_planner"), new__symbol(cause, "semantic_planner__stack")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "set"),                 new__symbol(cause, "stack"),           f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_planner"), new__symbol(cause, "semantic_planner__stack__set")));}
