...
f2ptr raw__semantic_resource__property__name__add(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__add(cause, this, new__symbol(cause, "property"), new__symbol(cause, "name"), that);
}

f2ptr f2__semantic_resource__property__name__add(f2ptr cause, f2ptr this, f2ptr that) {
  if (! raw__semantic_resource__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_resource__property__name__add(cause, this, that);
}
export_cefunk2(semantic_resource__property__name__add, this, that, 0, "");


f2ptr raw__semantic_resource__property__name__remove(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__remove(cause, this, new__symbol(cause, "property"), new__symbol(cause, "name"), that);
}

f2ptr f2__semantic_resource__property__name__remove(f2ptr cause, f2ptr this, f2ptr that) {
  if (! raw__semantic_resource__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_resource__property__name__remove(cause, this, that);
}
export_cefunk2(semantic_resource__property__name__remove, this, that, 0, "");
...
f2ptr f2__semantic_resource_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-add"),    new__symbol(cause, "property-name"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource"), new__symbol(cause, "semantic_resource__property__name__add")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-remove"), new__symbol(cause, "property-name"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource"), new__symbol(cause, "semantic_resource__property__name__remove")));}
  return this;
}
...
f2ptr f2__semantic_resource__core_extension_initialize(f2ptr cause) {
  f2ptr result = f2__force_funk_apply(cause, f2__this__fiber(cause), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_knowledge_base"), new__symbol(cause, "semantic_frame__core_extension_ping")), nil);
