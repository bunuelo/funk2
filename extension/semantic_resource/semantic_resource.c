...
f2ptr raw__semantic_resource__current_action_sequence__lookup_set(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_set(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "current_action_sequence"));
}

f2ptr f2__semantic_resource__current_action_sequence__lookup_set(f2ptr cause, f2ptr this) {
  if (! raw__semantic_resource__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_resource__current_action_sequence__lookup_set(cause, this);
}
export_cefunk1(semantic_resource__current_action_sequence__lookup_set, this, 0, "");
...
f2ptr f2__semantic_resource_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "current_action_sequence"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource"), new__symbol(cause, "semantic_resource__current_action_sequence__lookup_set")));}
