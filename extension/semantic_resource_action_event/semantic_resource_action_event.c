...
f2ptr f2__semantic_resource_action_event__agent__lookup_set(f2ptr cause, f2ptr this) {
  ...
  return raw__semantic_resource_action_event__agent__lookup_set(cause, this);
}
export_cefunk1(semantic_resource_action_event__agent__lookup_set, this, 0, "");
...
f2ptr raw__semantic_resource_action_event__event_sequence__lookup_set(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup_set(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "event_sequence"));
}
...
f2ptr f2__semantic_resource_action_event__event_sequence__lookup_set(f2ptr cause, f2ptr this) {
  ...
  return raw__semantic_resource_action_event__event_sequence__lookup_set(cause, this);
}
export_cefunk1(semantic_resource_action_event__event_sequence__lookup_set, this, 0, "");
...
f2ptr raw__semantic_resource_action_event__cairo_render_frame(f2ptr cause, f2ptr this) {
  ...
  {
    f2ptr target_set = f2__semantic_directed_action_event__target__lookup_set(cause, this);
    if (target_set != nil) {
...
f2ptr f2__semantic_resource_action_event_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "agent"),              f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource_action_event"), new__symbol(cause, "semantic_resource_action_event__agent__lookup_set")));}
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-lookup_set"), new__symbol(cause, "event_sequence"),     f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource_action_event"), new__symbol(cause, "semantic_resource_action_event__event_sequence__lookup_set")));}
