...
f2ptr raw__semantic_resource_action_event__relationship__target__add(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__add(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "target"), that);
}

f2ptr f2__semantic_resource_action_event__relationship__target__add(f2ptr cause, f2ptr this, f2ptr that) {
  if ((! raw__semantic_resource_action_event__is_type(cause, this)) ||
      (! raw__semantic_frame__is_type(cause, that))) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_resource_action_event__relationship__target__add(cause, this, that);
}
export_cefunk2(semantic_resource_action_event__relationship__target__add, this, that, 0, "");


f2ptr raw__semantic_resource_action_event__relationship__target__remove(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__remove(cause, this, new__symbol(cause, "relationship"), new__symbol(cause, "target"), that);
}

f2ptr f2__semantic_resource_action_event__relationship__target__remove(f2ptr cause, f2ptr this, f2ptr that) {
  if ((! raw__semantic_resource_action_event__is_type(cause, this)) ||
      (! raw__semantic_frame__is_type(cause, that))) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_resource_action_event__relationship__target__remove(cause, this, that);
}
export_cefunk2(semantic_resource_action_event__relationship__target__remove, this, that, 0, "");
...
f2ptr f2__semantic_resource_action_event_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.execute__symbol, new__symbol(cause, "new"),     f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource_action_event"), new__symbol(cause, "semantic_resource_action_event__new")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.execute__symbol, new__symbol(cause, "is_type"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource_action_event"), new__symbol(cause, "semantic_resource_action_event__is_type")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.get__symbol,     new__symbol(cause, "type"),    f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_resource_action_event"), new__symbol(cause, "semantic_resource_action_event__type")));}
  return this;
}
...
f2ptr f2__semantic_resource_action_event__core_extension_ping(f2ptr cause) {
  return nil;
}
export_cefunk0(semantic_resource_action_event__core_extension_ping, 0, "");

f2ptr f2__semantic_resource_action_event__core_extension_initialize(f2ptr cause) {
  f2ptr result = f2__force_funk_apply(cause, f2__this__fiber(cause), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_directed_action_event"), new__symbol(cause, "semantic_directed_action_event__core_extension_ping")), nil);
...
export_cefunk0(semantic_resource_action_event__core_extension_initialize, 0, "");

f2ptr f2__semantic_resource_action_event__core_extension_destroy(f2ptr cause) {
  status("semantic_resource_action_event destroyed.");
  return nil;
}
export_cefunk0(semantic_resource_action_event__core_extension_destroy, 0, "");
