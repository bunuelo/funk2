...
export_cefunk1(semantic_resource_event_knowledge_base__type, thing, 0, "Returns the specific type of object that this semantic_resource_event_knowledge_base is.");
