...
#ifndef F2__EXTENSION__SEMANTIC_SELF__H
#define F2__EXTENSION__SEMANTIC_SELF__H

#include "../semantic_object/semantic_object.h"
#include "../semantic_event/semantic_event.h"


f2ptr     raw__semantic_self__type_create  (f2ptr cause, f2ptr this, f2ptr semantic_realm, f2ptr time);
f2ptr     raw__semantic_self__new          (f2ptr cause, f2ptr semantic_realm, f2ptr time);
f2ptr      f2__semantic_self__new          (f2ptr cause, f2ptr semantic_realm, f2ptr time);
...
f2ptr     raw__semantic_self__event__lookup(f2ptr cause, f2ptr this);
f2ptr      f2__semantic_self__event__lookup(f2ptr cause, f2ptr this);
...
#endif // F2__EXTENSION__SEMANTIC_SELF__H
