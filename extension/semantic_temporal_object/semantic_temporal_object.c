...
f2ptr f2__semantic_temporal_object_type__new(f2ptr cause) {
  f2ptr this = f2__primobject_type__new(cause, f2list1__new(cause, new__symbol(cause, "semantic_ordered_object")));
  ...
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-next-lookup"),     new__symbol(cause, "temporal"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_temporal_object"), new__symbol(cause, "semantic_temporal_object__temporal__next__lookup")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-next-add"),        new__symbol(cause, "temporal"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_temporal_object"), new__symbol(cause, "semantic_temporal_object__temporal__next__add")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-next-remove"),     new__symbol(cause, "temporal"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_temporal_object"), new__symbol(cause, "semantic_temporal_object__temporal__next__remove")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-previous-lookup"), new__symbol(cause, "temporal"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_temporal_object"), new__symbol(cause, "semantic_temporal_object__temporal__previous__lookup")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-previous-add"),    new__symbol(cause, "temporal"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_temporal_object"), new__symbol(cause, "semantic_temporal_object__temporal__previous__add")));}
  {f2__primobject_type__add_slot_type(cause, this, new__symbol(cause, "semantic-previous-remove"), new__symbol(cause, "temporal"), f2__core_extension_funk__new(cause, new__symbol(cause, "semantic_temporal_object"), new__symbol(cause, "semantic_temporal_object__temporal__previous__remove")));}
  return this;
}
