...
f2ptr raw__semantic_event__absolute_time__lookup(f2ptr cause, f2ptr this) {
  return raw__semantic_frame__lookup(cause, this, new__symbol(cause, "property"), new__symbol(cause, "absolute_time"));
}

f2ptr f2__semantic_event__absolute_time__lookup(f2ptr cause, f2ptr this) {
  if (! raw__semantic_event__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_event__absolute_time__lookup(cause, this);
}
export_cefunk1(semantic_event__absolute_time__lookup, this, 0, "");


f2ptr raw__semantic_event__absolute_time__add(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__add(cause, this, new__symbol(cause, "property"), new__symbol(cause, "absolute_time"), that);
}

f2ptr f2__semantic_event__absolute_time__add(f2ptr cause, f2ptr this, f2ptr that) {
  if (! raw__semantic_event__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_event__absolute_time__add(cause, this, that);
}
export_cefunk2(semantic_event__absolute_time__add, this, that, 0, "");


f2ptr raw__semantic_event__absolute_time__remove(f2ptr cause, f2ptr this, f2ptr that) {
  return raw__semantic_frame__remove(cause, this, new__symbol(cause, "property"), new__symbol(cause, "absolute_time"), that);
}

f2ptr f2__semantic_event__absolute_time__remove(f2ptr cause, f2ptr this, f2ptr that) {
  if (! raw__semantic_event__is_type(cause, this)) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__semantic_event__absolute_time__remove(cause, this, that);
}
export_cefunk2(semantic_event__absolute_time__remove, this, that, 0, "");
