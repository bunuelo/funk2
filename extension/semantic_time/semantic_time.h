...
#ifndef F2__EXTENSION__SEMANTIC_TIME__H
#define F2__EXTENSION__SEMANTIC_TIME__H
...
def_header_ceframe1(semantic_relative_time, value);
...
#endif // F2__EXTENSION__SEMANTIC_TIME__H
