...
boolean_t raw__timeline_event__overlaps(f2ptr cause, f2ptr this, f2ptr event) {
  ...
  return (((f2__is_less_than(   cause, end_time,          event__start_time) != nil) &&
	  ...
	  ((f2__is_less_than(   cause, event__end_time,   start_time)        != nil) &&
	   (f2__is_greater_than(cause, event__start_time, start_time)        != nil))   ||
	  ((f2__is_less_than(   cause, event__end_time,   end_time)          != nil) &&
	   (f2__is_greater_than(cause, event__start_time, end_time)          != nil)));
}
