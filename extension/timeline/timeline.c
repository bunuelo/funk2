...
f2ptr f2__timeline__new(f2ptr cause, f2ptr width, f2ptr height, f2ptr rgba_data) {
  ...
  return raw__timeline__new(cause, width, height, rgba_data);
}
export_cefunk3(timeline__new, width, height, rgba_data, 0, "Returns a new timeline object.  rgba_data can be nil, in which case a black timeline is returned.");
...
f2ptr raw__timeline__new_from_rgb_data(f2ptr cause, f2ptr width, f2ptr height, f2ptr rgb_data) {
  ...
  return f2__timeline__new(cause, width, height, rgba_data);
}
...
f2ptr f2__timeline__new_from_rgb_data(f2ptr cause, f2ptr width, f2ptr height, f2ptr rgb_data) {
  ...
  return raw__timeline__new_from_rgb_data(cause, width, height, rgb_data);
}
export_cefunk3(timeline__new_from_rgb_data, width, height, rgb_data, 0, "Returns a new timeline object from rgb_data.");
...
f2ptr f2__timeline__height(f2ptr cause, f2ptr this) {
  ...
  return raw__timeline__height(cause, this);
}
export_cefunk1(timeline__height, thing, 0, "Returns the height of the timeline.");
...
f2ptr f2__timeline__height__set(f2ptr cause, f2ptr this, f2ptr value) {
  ...
  return raw__timeline__height__set(cause, this, value);
}
export_cefunk2(timeline__height__set, thing, value, 0, "Sets the height of the timeline.");
...
f2ptr f2__timeline__rgba_data(f2ptr cause, f2ptr this) {
  ...
  return raw__timeline__rgba_data(cause, this);
}
export_cefunk1(timeline__rgba_data, thing, 0, "Returns the rgba_data of the timeline.");
...
f2ptr f2__timeline__rgba_data__set(f2ptr cause, f2ptr this, f2ptr value) {
  ...
  return raw__timeline__rgba_data__set(cause, this, value);
}
export_cefunk2(timeline__rgba_data__set, thing, value, 0, "Sets the rgba_data of the timeline.");
...
f2ptr raw__timeline__write_reduction_timeline_part(f2ptr cause, f2ptr this, f2ptr reduced_timeline, f2ptr reduction_factor, f2ptr x_offset, f2ptr y_offset) {
  f2ptr this__rgba_data          = raw__timeline__rgba_data(cause, this);
  f2ptr this__width              = raw__timeline__width(    cause, this);
  f2ptr this__height             = raw__timeline__height(   cause, this);
  f2ptr reduced_timeline__width     = raw__timeline__width(    cause, reduced_timeline);
  f2ptr reduced_timeline__height    = raw__timeline__height(   cause, reduced_timeline);
  f2ptr reduced_timeline__rgba_data = raw__timeline__rgba_data(cause, reduced_timeline);
  s64   this__width__i           = f2integer__i(this__width,           cause);
  s64   this__height__i          = f2integer__i(this__height,          cause);
  s64   reduced_timeline__width__i  = f2integer__i(reduced_timeline__width,  cause);
  s64   reduced_timeline__height__i = f2integer__i(reduced_timeline__height, cause);
  ...
  {
    s64 reduced_timeline__y;
    for (reduced_timeline__y = 0; reduced_timeline__y < reduced_timeline__height__i; reduced_timeline__y ++) {
      s64 this__y = (reduced_timeline__y * reduction_factor__i) + y_offset__i;
      {
	if ((this__y >= 0) && (this__y < this__height__i)) {
	  s64 reduced_timeline__x;
	  for (reduced_timeline__x = 0; reduced_timeline__x < reduced_timeline__width__i; reduced_timeline__x ++) {
	    s64 this__x = (reduced_timeline__x * reduction_factor__i) + x_offset__i;
	    if ((this__x >= 0) && (this__x < this__width__i)) {
	      s64 reduced_timeline__pixel_index = ((reduced_timeline__y * reduced_timeline__width__i) + reduced_timeline__x) << 2;
	      s64 this__pixel_index          = ((this__y          * this__width__i)          + this__x)          << 2;
	      u64 red   = raw__chunk__bit8__elt(cause, reduced_timeline__rgba_data, reduced_timeline__pixel_index + 0);
	      u64 green = raw__chunk__bit8__elt(cause, reduced_timeline__rgba_data, reduced_timeline__pixel_index + 1);
	      u64 blue  = raw__chunk__bit8__elt(cause, reduced_timeline__rgba_data, reduced_timeline__pixel_index + 2);
	      u64 alpha = raw__chunk__bit8__elt(cause, reduced_timeline__rgba_data, reduced_timeline__pixel_index + 3);
...
f2ptr f2__timeline__write_reduction_timeline_part(f2ptr cause, f2ptr this, f2ptr reduced_timeline, f2ptr reduction_factor, f2ptr x_offset, f2ptr y_offset) {
  if ((! raw__timeline__is_type(cause, this)) ||
      (! raw__timeline__is_type(cause, reduced_timeline)) ||
      (! raw__integer__is_type(cause, reduction_factor)) ||
      (! raw__integer__is_type(cause, x_offset)) ||
      (! raw__integer__is_type(cause, y_offset))) {
    return f2larva__new(cause, 1, nil);
  }
  return raw__timeline__write_reduction_timeline_part(cause, this, reduced_timeline, reduction_factor, x_offset, y_offset);
}
export_cefunk5(timeline__write_reduction_timeline_part, this, reduced_timeline, reduction_factor, x_offset, y_offset, 0, "");


f2ptr raw__timeline__copy_rectangle_to(f2ptr cause, f2ptr this, s64 min_x, s64 min_y, f2ptr target, s64 target_min_x, s64 target_min_y, s64 rectangle_width, s64 rectangle_height) {
  f2ptr this__width       = raw__timeline__width(cause, this);
  s64   this__width__i    = f2integer__i(this__width, cause);
  f2ptr this__height      = raw__timeline__height(cause, this);
  s64   this__height__i   = f2integer__i(this__height, cause);
  f2ptr this__rgba_data   = raw__timeline__rgba_data(cause, this);
  f2ptr target__width     = raw__timeline__width(cause, target);
  s64   target__width__i  = f2integer__i(target__width, cause);
  f2ptr target__height    = raw__timeline__height(cause, target);
  s64   target__height__i = f2integer__i(target__height, cause);
  f2ptr target__rgba_data = raw__timeline__rgba_data(cause, target);
  if ((rectangle_width  < 0) ||
    ...
    return f2larva__new(cause, 3, f2__bug__new(cause, f2integer__new(cause, 3), f2__frame__new(cause, f2list24__new(cause,
														    new__symbol(cause, "bug_type"),         new__symbol(cause, "copy_dimensions_are_outside_of_timeline_dimensions"),
														    new__symbol(cause, "funkname"),         new__symbol(cause, "timeline-copy_rectangle_to"),
...
f2ptr f2__timeline__copy_rectangle_to(f2ptr cause, f2ptr this, f2ptr min_x, f2ptr min_y, f2ptr target, f2ptr target_min_x, f2ptr target_min_y, f2ptr rectangle_width, f2ptr rectangle_height) {
  if ((! raw__timeline__is_type(cause, this)) ||
      (! raw__integer__is_type(cause, min_x)) ||
      (! raw__integer__is_type(cause, min_y)) ||
      (! raw__timeline__is_type(cause, target)) ||
  ...
  return raw__timeline__copy_rectangle_to(cause, this, min_x__i, min_y__i, target, target_min_x__i, target_min_y__i, rectangle_width__i, rectangle_height__i);
}
export_cefunk8(timeline__copy_rectangle_to, this, min_x, min_y, target, target_min_x, target_min_y, rectangle_width, rectangle_height, 0, "Copy a rectangle from this timeline to the target timeline.");


f2ptr raw__timeline__fill_rectangle(f2ptr cause, f2ptr this, s64 min_x, s64 min_y, s64 width, s64 height, u8 red, u8 green, u8 blue, u8 alpha) {
  f2ptr this__width       = raw__timeline__width(cause, this);
  s64   this__width__i    = f2integer__i(this__width, cause);
  f2ptr this__height      = raw__timeline__height(cause, this);
  s64   this__height__i   = f2integer__i(this__height, cause);
...
f2ptr f2__timeline__fill_rectangle(f2ptr cause, f2ptr this, f2ptr min_x, f2ptr min_y, f2ptr width, f2ptr height, f2ptr red, f2ptr green, f2ptr blue, f2ptr alpha) {
  if ((! raw__timeline__is_type(cause, this)) ||
      (! raw__integer__is_type(cause, min_x)) ||
      (! raw__integer__is_type(cause, min_y)) ||
  ...
  return raw__timeline__fill_rectangle(cause, this, min_x__i, min_y__i, width__i, height__i, red__i, green__i, blue__i, alpha__i);
}
export_cefunk9(timeline__fill_rectangle, this, min_x, min_y, width, height, red, green, blue, alpha, 0, "Fill a rectangle in this timeline with the given red, green, blue, and alpha components, each within the range from 0 to 255.");


f2ptr raw__timeline__clear(f2ptr cause, f2ptr this, u8 red, u8 green, u8 blue, u8 alpha) {
  f2ptr width     = raw__timeline__width( cause, this);
  f2ptr height    = raw__timeline__height(cause, this);
  s64   width__i  = f2integer__i(width,  cause);
  s64   height__i = f2integer__i(height, cause);
  return raw__timeline__fill_rectangle(cause, this, 0, 0, width__i, height__i, red, green, blue, alpha);
}

f2ptr f2__timeline__clear(f2ptr cause, f2ptr this, f2ptr red, f2ptr green, f2ptr blue, f2ptr alpha) {
  if ((! raw__timeline__is_type(  cause, this)) ||
      (! raw__integer__is_type(cause, red)) ||
      (! raw__integer__is_type(cause, green)) ||
      (! raw__integer__is_type(cause, blue)) ||
  ...
  return raw__timeline__clear(cause, this, red__i, green__i, blue__i, alpha__i);
}
export_cefunk5(timeline__clear, this, red, green, blue, alpha, 0, "Fills this entire timeline with the given red, green, blue, and alpha components, each within the range from 0 to 255.");
...
f2ptr f2__timeline_type__new(f2ptr cause) {
  ...
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.get__symbol,     new__symbol(cause, "height"),                     f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__height")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.set__symbol,     new__symbol(cause, "height"),                     f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__height__set")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.get__symbol,     new__symbol(cause, "rgba_data"),                  f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__rgba_data")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.set__symbol,     new__symbol(cause, "rgba_data"),                  f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__rgba_data__set")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.execute__symbol, new__symbol(cause, "write_reduction_timeline_part"), f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__write_reduction_timeline_part")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.execute__symbol, new__symbol(cause, "copy_rectangle_to"),          f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__copy_rectangle_to")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.execute__symbol, new__symbol(cause, "fill_rectangle"),             f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__fill_rectangle")));}
  {f2__primobject_type__add_slot_type(cause, this, __funk2.globalenv.execute__symbol, new__symbol(cause, "clear"),                      f2__core_extension_funk__new(cause, new__symbol(cause, "timeline"), new__symbol(cause, "timeline__clear")));}
  return this;
}
