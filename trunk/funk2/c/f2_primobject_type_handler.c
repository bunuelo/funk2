...
f2ptr f2__add_type(f2ptr cause, f2ptr type_name, f2ptr type) {return funk2_primobject_type_handler__add_type(&(__funk2.primobject_type_handler), cause, type_name, type);}
