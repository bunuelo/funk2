...
typedef struct funk2_object_type__funk__slot_s {
  ...
  f2ptr args__set__symbol;
  f2ptr args__set__funk;
  f2ptr demetropolize_body__symbol;
  f2ptr demetropolize_body__funk;
  f2ptr demetropolize_body__set__symbol;
  f2ptr demetropolize_body__set__funk;
  f2ptr body__symbol;
  f2ptr body__funk;
...
typedef struct funk2_object_type__thread__slot_s {
  ...
  f2ptr program_counter_reg__set__funk;
  f2ptr stack_reg__symbol;
  f2ptr stack_reg__funk;
  f2ptr stack_reg__set__symbol;
  f2ptr stack_reg__set__funk;
  f2ptr iter_reg__symbol;
  f2ptr iter_reg__funk;
  f2ptr iter_reg__set__symbol;
  f2ptr iter_reg__set__funk;
  f2ptr env_reg__symbol;
  f2ptr env_reg__funk;
  f2ptr env_reg__set__symbol;
  f2ptr env_reg__set__funk;
  f2ptr args_reg__symbol;
  f2ptr args_reg__funk;
  f2ptr args_reg__set__symbol;
  f2ptr args_reg__set__funk;
  f2ptr return_reg__symbol;
  f2ptr return_reg__funk;
  f2ptr return_reg__set__symbol;
  f2ptr return_reg__set__funk;
  f2ptr value_reg__symbol;
  f2ptr value_reg__funk;
  f2ptr value_reg__set__symbol;
  f2ptr value_reg__set__funk;
  f2ptr trace_reg__symbol;
  f2ptr trace_reg__funk;
  f2ptr trace_reg__set__symbol;
  f2ptr trace_reg__set__funk;
...
typedef struct funk2_object_type__cause__slot_s {
  ...
  f2ptr bmemory_tracing_on__symbol;
  f2ptr bmemory_tracing_on__funk;
  f2ptr bmemory_tracing_on__set__symbol;
  f2ptr bmemory_tracing_on__set__funk;
